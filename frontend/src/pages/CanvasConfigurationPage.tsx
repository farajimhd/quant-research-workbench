...
const INDICATOR_SERIES = [
  ...
  { autoscaleMax: 1, autoscaleMin: 0, axisTitle: "Field", column: "qmd_structure_support_field", color: "var(--success)", displayItemId: "indicator.qmd_structural_pressure", label: "Support field", lineWidth: 2, pane: "qmd_structural_pressure", priceScaleId: "left" },
  { autoscaleMax: 1, autoscaleMin: 0, axisTitle: "Field", column: "qmd_structure_resistance_field", color: "var(--danger)", displayItemId: "indicator.qmd_structural_pressure", label: "Resistance field", lineWidth: 2, pane: "qmd_structural_pressure", priceScaleId: "left" },
