...
import { MarketScannerContainer, SCANNER_TIMEFRAMES, SignalStreamContainer, StrategyActivityContainer, WatchUniverseContainer, type ScannerSnapshotMeta, type StrategyActivitySettings, type WatchlistRuntimeResponse } from "../app/components/MarketScreenerContainers";
...
import {
  ...
  PreviewRow,
  QmdBarHistory,
  QmdIndicatorProvenance,
  QmdLiveBar,
  QmdLiveChartPayload,
  QmdMarketSignalEvent,
  QmdStructureEvent,
  QmdStructureLevelCandidate,
  QmdStructureTimeframeState,
...
import {
  ...
  barStartTime,
  chartHistoryLimitNotice,
  chartInitialPageSize,
  chartPageSize,
  chartRowBudget,
  closedRowsAtCutoff,
  earlierChartHistoryRequest,
  extendedSessionRegions,
  limitLiveRowsWithHysteresis,
  limitRowsToLatest,
  marketSessionDate,
  mergeHistoricalChartPage,
  mergeMarketSignalEvents,
  mergeRowsByTime,
  mergeStructureEvents,
  mergeStructureLevelHistory,
  normalizedRowsByTime,
  qmdMarketSignalChartMarkers,
  requestedIndicatorColumns,
  shallowRowEqual,
  timeframeDurationMs,
  updateHistoryCursor,
  useCanvasHistoricalChart,
} from "../features/canvas/chartData";
import { boundedUnit, finiteNumber } from "../features/canvas/numbers";
...
} from "../features/canvas/structureModel";
