    ...
    instanceSettings: {
      ...
      charts_quotes: {
        ...
        charts_quotes: {
          ...
          main: { ...chartsQuotesSettings.charts_quotes.main, ...(ticker ? { symbol: ticker } : {}), timeframe: "1s" },
