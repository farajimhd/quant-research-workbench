...
import { SecFilingDetailModal as SecFilingDetailModalFeature } from "../features/services/SecFilingDetailModal";
...
function SecTodayRowsPanel({ onSortChange, state }: { onSortChange: (sort: SecTodaySort) => void; state: SecTodayRowsState }) {
    ...
    <Panel className="sec-today-panel" title="Today's SEC Filings And XBRL">
      ...
      {selectedRow ? (
        <Modal className="sec-filing-detail-modal-panel" onClose={() => { setSelectedRow(null); setDetail(null); setDetailError(""); }} title="SEC Filing Detail">
          <SecFilingDetailModalFeature detail={detail} error={detailError} loading={detailLoading} row={selectedRow} />
        </Modal>
      ) : null}
    </Panel>
  );
    ...
    <div className="news-full-detail">
      <article className="news-full-article-card">
        ...
        <div className="news-full-time-grid">
          <ServiceTimeCard label="Market time" timeZone={EXCHANGE_TIME_ZONE} value={publishedAt} />
          <ServiceTimeCard label="Vancouver" timeZone={VANCOUVER_TIME_ZONE} value={publishedAt} />
          <ServiceTimeCard label="UTC" timeZone="UTC" value={publishedAt} />
        </div>
