import { Activity, AlertTriangle, ArrowUpRight, CheckCircle2, Clock3, Cpu, DatabaseZap, Layers3, Loader2, RadioTower, RefreshCcw, RotateCcw, Save, Search, Settings2, ShieldCheck, WifiOff, X } from "lucide-react";
...
function ServiceOperationalAuthorityPanel({ service }: { service: ServiceStatusPayload }) {
  ...
  return (
    <Panel className="service-operational-authority-panel" title="Operational Authority">
      <div className="service-operational-authority-grid">
        ...
        <OperationalAuthorityMetric detail={lastEvent || "No event or observation clock"} label="Freshness" value={lastEvent ? formatTime(lastEvent) : "Unknown"} />
