...
type SignalStream = BaseComposition & { cooldown_ms: number; enabled: boolean; maximum_events: number; origin?: string; protected?: boolean; rearm_policy: "after_false" | "after_cooldown"; revision: number; signal_stream_id: string; source_id: string; source_scan_id: string; source_type: "core_scan" | "watchlist" | "news_events"; trigger_policy: "false_to_true"; watchlist_routes: SignalRoute[] };
