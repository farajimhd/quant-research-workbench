...
const STRATEGY_PARAMETER_HELP: Record<string, string> = {
  ...
  min_reentry_macd_hist_z_since_open: "Minimum completed-bar MACD histogram z-score since the open required for Long Momentum v9 watchlist reentry.",
  ...
  return [
    ...
    },
    {
      filters: {
        ...
        last_macd_hist_z_since_open: gtFilter(strategyNumberParam(params, "min_reentry_macd_hist_z_since_open", 0.2)),
      },
      label: "v9 Watchlist Entry Raw",
      title: "Apply the raw/provider inputs available before v9 checks watchlist state, last_close > last_vwap, last_close >= last_open, 1m BVD is not above the threshold, and MACD z-score is above the threshold.",
    },
    {
      filters: {
    ...
    return [
      ...
      },
      {
        filters: {
          ...
          long_momentum_v9_reentry_macd_ok: trueFilter(),
        },
        label: "v9 Watchlist VWAP Entry",
        title: "Apply the v9 watchlist entry gates: ticker is on watchlist, not held/pending, last close is above VWAP, the reclaim bar is not red, 1m BVD is not above the threshold, and MACD z-score is constructive.",
      },
      {
        filters: {
...
const SCANNER_IMPORTANT_COLUMNS = [
  ...
  "long_momentum_v9_reentry_macd_ok",
  "long_momentum_v9_reentry_macd_hist_z",
  "long_momentum_v9_reentry_macd_hist_z_threshold",
