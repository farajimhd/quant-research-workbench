...
const STRATEGY_PARAMETER_HELP: Record<string, string> = {
  ...
  high_break_stop_offset_ratio: "High Break Hold stop offset as a ratio, not whole percent. 0.035 means the fixed stop is 3.5% below the breakout level.",
  high_break_soft_exit_unlock_profit_pct: "High Break Hold profit threshold as a ratio, not whole percent. 0.10 means TEMA, 2xBVD, and pocket exits are unlocked after the open is at least 10% above entry.",
  ...
  adaptive_pocket_enabled: "When enabled, Long Momentum v9 calculates the pocket threshold from provider-built short true-range volatility instead of using the fixed pocket percentage.",
  pocket_profit_pct: "Long Momentum v9 fixed pocket threshold, and the fallback threshold if adaptive pocketing is enabled but short volatility is unavailable.",
...
const STRATEGY_PARAMETER_LABELS: Record<string, string> = {
  ...
  high_break_soft_exit_unlock_profit_pct: "High Break Soft Exit Unlock Profit Ratio",
...
const SCANNER_IMPORTANT_COLUMNS = [
  ...
  "long_momentum_v9_reentry_tema_open_threshold",
  ...
  "long_momentum_v9_pocket_open",
  "long_momentum_v9_pocket_mode",
  "long_momentum_v9_pocket_pct",
  ...
  "long_momentum_v9_first_entry_high_lifecycle_enabled",
  "long_momentum_v9_first_entry_high_bars_observed",
  "long_momentum_v9_first_entry_last_high",
  "long_momentum_v9_first_entry_highest_high",
  "long_momentum_v9_first_entry_near_high_threshold",
  "long_momentum_v9_first_entry_new_high",
  "long_momentum_v9_first_entry_near_high",
  "long_momentum_v9_first_entry_no_new_high_count",
  "long_momentum_v9_first_entry_high_stall_required",
  "long_momentum_v9_first_entry_high_near_tolerance_ratio",
  "long_momentum_v9_first_entry_high_stall_confirmed",
  ...
  "long_momentum_v9_high_break_soft_exit_profit_pct",
  "long_momentum_v9_high_break_soft_exit_unlock_profit_pct",
  "long_momentum_v9_high_break_soft_exit_unlock_price",
  "long_momentum_v9_high_break_soft_exit_profit_unlocked",
  "long_momentum_v9_high_break_soft_exit_profit_unlocked_at_open",
