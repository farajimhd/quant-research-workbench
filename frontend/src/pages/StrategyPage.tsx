...
function interactiveDebugRawFilterPresets(config: StrategyConfig): DataTableFilterPreset[] | undefined {
  ...
  return [
    ...
    },
    {
      ...
      title: "Apply the raw/provider inputs available before v9 checks watchlist state, last_close > last_vwap, last_close >= last_open, 1m BVD is not above the threshold, and current_open breaks the highest body of the last two completed bars.",
    },
    {
      filters: {
  ...
  if (version === "v9") {
    return [
      ...
      },
      {
        ...
        title: "Apply the v9 watchlist entry gates: ticker is on watchlist, not held/pending, last close is above VWAP, the reclaim bar is not red, 1m BVD is not above the threshold, and current_open breaks the highest body of the last two completed bars.",
      },
      {
        filters: {
