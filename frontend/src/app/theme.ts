...
export function applyThemeDefinition(target: HTMLElement, themeId: AppThemeId = DEFAULT_THEME_ID): void {
  ...
  const variables: Record<string, string> = {
    ...
    "--position-entry": "#0088ff",
    "--position-profit": "#00df62",
    "--position-stop": "#ff1744",
    ...
    "--chart-v6-historicalResistance": theme.tone === "light" ? "#991b1b" : "#c94b50",
    "--chart-v6-currentResistance": theme.tone === "light" ? "#ef4444" : "#ff9298",
    "--chart-v6-historicalSupport": theme.tone === "light" ? "#166534" : "#31966a",
    "--chart-v6-currentSupport": theme.tone === "light" ? "#22a86b" : "#79e2ac",
