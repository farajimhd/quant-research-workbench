...
export type HistoricalBar = { timeframe?: string; bar_end?: string; bar_start: string; close: number; high: number; is_closed?: boolean; last_event_ts?: string; low: number; open: number; volume: number };
...
export type CanonicalTradingPreview = {
  ...
  strategy_chart_activity_symbol?: string;
