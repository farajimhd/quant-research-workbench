...
export const CHART_INDICATORS: ChartDisplayItem[] = [
  ...
  displayIndicator("indicator.qmd_unified_structure", "QMD Unified Structural Levels", "price_action", [
    ...
    "Green bands are levels currently confirmed as support. Labels expose hold_quality_score and ticker_relative_quality_score with their raw counts, reference-session population, provisional status, pivots, role flips, and executed pressure.",
