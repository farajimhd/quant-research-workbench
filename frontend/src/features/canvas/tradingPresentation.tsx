...
function PositionsPreview({ data, onSymbolSelect, settings }: { data: CanonicalTradingPreview; onSymbolSelect?: (symbol: string) => void; settings: ContainerSettings["positions"] }) {
  ...
  const openColumns = settings.showPnl ? ["symbol", "side", "quantity", "average_price", "mark", "return_pct", "market_value", "unrealized_pnl", "orders", "fills", "account", "requested_at", "opened_at"] : ["symbol", "side", "quantity", "average_price", "mark", "market_value", "orders", "fills", "account", "requested_at", "opened_at"];
