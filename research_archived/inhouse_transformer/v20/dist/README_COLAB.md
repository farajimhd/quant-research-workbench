# Colab Package for v20

Files in this folder are generated for Colab training.

## Drive Paths

- Code package in Colab: `/content/drive/MyDrive/quant-research-workbench/colab_code/v20`
...
- output name: `v20_generalization_june2025_all_tickers`
- wandb run name: `v20-generalization-june2025-all-tickers`
- resume latest: `True`
