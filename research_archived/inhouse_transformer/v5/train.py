...
from research.inhouse_transformer.v5.config import (  # noqa: E402
    DataConfig,
    ExperimentConfig,
    ModelConfig,
    TrainConfig,
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help=(
            "Main transformer target format. v5 defaults to return_bps so the model predicts the next move "
...
def input_experiment_name(config: ExperimentConfig) -> str:
    if config.data.input_normalization == "window_zscore_only":
        return "anchored-activity-window-zscore"
...
def load_torch_stack() -> None:
    ...
    try:
        ...
        from research.inhouse_transformer.v5.model import (
