# Colab Package for v16

Files in this folder are generated for Colab training.

## Drive Paths

- Code package in Colab: `/content/drive/MyDrive/quant-research-workbench/colab_code/v16`
...
- output name: `v16_generalization_june2025_all_tickers`
- wandb run name: `v16-generalization-june2025-all-tickers`
- resume latest: `True`
