...
def save_masked_event_model_architecture_artifacts(
    *,
    model: Any,
    data_config: Any,
    output_dir: Path,
    ...
    return _save_raw_model_architecture_artifacts(
        model=wrapped,
...
def _save_raw_model_architecture_artifacts(
    *,
    model: Any,
    data_config: Any,
    output_dir: Path,
...
def save_model_architecture_artifacts(
    *,
    ...
    return save_masked_event_model_architecture_artifacts(
        model=model,
        data_config=data_config,
        output_dir=output_dir,
        version=version,
