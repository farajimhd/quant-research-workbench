...
def run_backtest(config_dict: dict, progress_callback=None, cancel_check=None) -> dict:
    ...
    return engine.run(progress_callback=progress_callback, cancel_check=cancel_check)
