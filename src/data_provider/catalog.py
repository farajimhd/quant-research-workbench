...
def price_action_knowledge(lower: str, group: str, category: str, title: str) -> dict[str, Any]:
    details = {
        ...
        "green_body_avg": ("Average green body contribution per session bar.", "Green body average divides cumulative green body size by session_bar_count, so non-green bars remain part of the denominator as requested.", "$$GreenBodyAvg_t=\\frac{GreenBodySumSoFar_t}{SessionBarCount_t}$$"),
        "red_body_avg": ("Average red body contribution per session bar.", "Red body average divides cumulative red body size by session_bar_count, so non-red bars remain part of the denominator as requested.", "$$RedBodyAvg_t=\\frac{RedBodySumSoFar_t}{SessionBarCount_t}$$"),
