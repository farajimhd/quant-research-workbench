...
GREEN_CLOSE_CEILING_PRICE_CONTRACT = 'early-squeeze-r1-price-green-close-ceiling-v14'
MACD_EPISODE_REENTRY_PRICE_CONTRACT = 'early-squeeze-r1-price-macd-1s-episode-reentry-v15'
DUAL_MACD_REENTRY_PRICE_CONTRACT = 'early-squeeze-r1-price-dual-macd-reentry-v16'
EPISODE_TARGET_CONTINUITY_PRICE_CONTRACT = 'early-squeeze-r1-price-episode-target-continuity-v17'
FORMING_EPISODE_PRICE_CONTRACT = 'early-squeeze-r1-price-forming-episode-v18'
CONFIRMED_BREAKOUT_PRICE_CONTRACT = 'early-squeeze-r1-price-confirmed-breakout-v19'
VOLATILITY_CHOP_PRICE_CONTRACT = 'early-squeeze-r1-price-volatility-chop-v20'
SIGNAL = 'signal.activation.price-squeeze-early'


def configure(p):
    if p.get('early_squeeze_breakout_contract') not in (LEGACY_CONTRACT, VWAP_CONTRACT, RECOVERY_CONTRACT, MIDPOINT_CONTRACT, LIFECYCLE_CONTRACT, CONTRACT, FAST_CONTRACT, CORRECTED_FAST_CONTRACT, PRICE_CONTRACT, STRICT_PRICE_CONTRACT, EPISODE_PRICE_CONTRACT, RESISTANCE_CEILING_PRICE_CONTRACT, BROKEN_RESISTANCE_CEILING_PRICE_CONTRACT, GREEN_CLOSE_CEILING_PRICE_CONTRACT, MACD_EPISODE_REENTRY_PRICE_CONTRACT, DUAL_MACD_REENTRY_PRICE_CONTRACT, EPISODE_TARGET_CONTINUITY_PRICE_CONTRACT, FORMING_EPISODE_PRICE_CONTRACT, CONFIRMED_BREAKOUT_PRICE_CONTRACT, VOLATILITY_CHOP_PRICE_CONTRACT):
...
def record_exit(state, at, role, remaining, *, contract=CONTRACT):
    ...
    if contract in (RECOVERY_CONTRACT, MIDPOINT_CONTRACT, LIFECYCLE_CONTRACT, CONTRACT, FAST_CONTRACT, CORRECTED_FAST_CONTRACT, PRICE_CONTRACT, STRICT_PRICE_CONTRACT, EPISODE_PRICE_CONTRACT, DUAL_MACD_REENTRY_PRICE_CONTRACT, EPISODE_TARGET_CONTINUITY_PRICE_CONTRACT, FORMING_EPISODE_PRICE_CONTRACT, CONFIRMED_BREAKOUT_PRICE_CONTRACT, VOLATILITY_CHOP_PRICE_CONTRACT) and not active.get('first_fill_at'):
        ...
        return
    if contract in (STRICT_PRICE_CONTRACT, EPISODE_PRICE_CONTRACT, DUAL_MACD_REENTRY_PRICE_CONTRACT, EPISODE_TARGET_CONTINUITY_PRICE_CONTRACT, FORMING_EPISODE_PRICE_CONTRACT, CONFIRMED_BREAKOUT_PRICE_CONTRACT, VOLATILITY_CHOP_PRICE_CONTRACT):
        d = state.setdefault('squeeze_breakout', {})
        key = active['anchor']['unified_level_id']
        if (contract not in (EPISODE_PRICE_CONTRACT, DUAL_MACD_REENTRY_PRICE_CONTRACT, EPISODE_TARGET_CONTINUITY_PRICE_CONTRACT, FORMING_EPISODE_PRICE_CONTRACT, CONFIRMED_BREAKOUT_PRICE_CONTRACT, VOLATILITY_CHOP_PRICE_CONTRACT)
                or key in d.get('breakout_highs', {})) and key not in d.setdefault('entered_levels', []):
...
def release_add(state, keys):
    ...
    if not active:
        return
    if active.get('single_use_adds'):
        for key in keys:
            active.setdefault('pending_adds', {}).pop(key, None)
...
def evaluate(host, a, o, p, old_state):
    if p['early_squeeze_breakout_contract'] in (PRICE_CONTRACT, STRICT_PRICE_CONTRACT, EPISODE_PRICE_CONTRACT,
                                                ...
                                                GREEN_CLOSE_CEILING_PRICE_CONTRACT,
                                                MACD_EPISODE_REENTRY_PRICE_CONTRACT,
                                                DUAL_MACD_REENTRY_PRICE_CONTRACT,
                                                EPISODE_TARGET_CONTINUITY_PRICE_CONTRACT, FORMING_EPISODE_PRICE_CONTRACT, CONFIRMED_BREAKOUT_PRICE_CONTRACT, VOLATILITY_CHOP_PRICE_CONTRACT):
