...
def normalize_position(row: dict[str, Any], account_id: str, snapshot_id: str) -> PositionState:
    ...
    return PositionState(
        ...
        max_unrealized_pnl=_optional_decimal(row.get("maxUnrealizedPnl") or row.get("max_unrealized_pnl")),
        max_unrealized_pnl_observed_from=str(row.get("maxUnrealizedPnlObservedFrom") or row.get("max_unrealized_pnl_observed_from") or ""),
        max_unrealized_pnl_as_of=str(row.get("maxUnrealizedPnlAsOf") or row.get("max_unrealized_pnl_as_of") or ""),
        max_unrealized_pnl_basis=str(row.get("maxUnrealizedPnlBasis") or row.get("max_unrealized_pnl_basis") or ""),
