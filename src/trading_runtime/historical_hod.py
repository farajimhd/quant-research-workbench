...
DEFAULTS = dict(stop_buffer_bps=5., target_offset_ticks=1., target_distance_fraction=.05, entry_breakout_offset=0.,
    ...
    setup_minimum_quote_clearance_spreads=0.,setup_trail_requires_current_gain=0,
...
def evaluate(host, a, o, p, state):
    ...
    if setup_enabled:
        transitioned = v7_setup.phase(active,d,fresh)
        if transitioned:
