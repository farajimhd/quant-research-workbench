...
def resistance_rejection(state, observation, levels):
    ...
    if tracker.get("entry_at") != entry_at:
    ...
    state["resistance_rejection_state"] = {"entry_at": entry_at, "timestamp": timestamp,
