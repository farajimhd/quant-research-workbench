# ORB 5-Minute Momentum Strategy v1
...
This version depends on provider-built daily context:

- 60 calendar days of prior `1d` bars
- `1d` feature groups: `core`, `volatility`

Those daily artifacts are used for average daily volume, ATR, and previous close.
