...
def qmd_signal_stream_candidates(
    ...
    fixed = {
        ...
        "news_recency", "live_news_recency", "live_news_count", "today_news_count", "sec_recency", "market_is_halted",
    ...
    try:
        ...
        if payload.get("row_count", 0) > 0:
            ...
            try:
                ...
                current_admissions = signal_stream_runtime.get("admissions_by_watchlist") or {}
                if current_admissions != existing_admissions:
                    watchlist_runtime = WATCHLIST_RUNTIME.resolve(
                        configuration,
                        rows,
                        as_of=cycle_as_of,
