...
PROFILE_ID='v7-upper-hod-zone-v1'
LABEL='V7 upper 30% HOD zone · resistance and transition breakout'
...
def build(base):
    ...
    p['historical_hod'].update(v7_zone_enabled=1,entry_zone_fraction=.30,
    ...
    profile['description']=('Causal V7 only; all origins equal. Completed non-red 1s resistance or resistance-origin transition '
        'breakout in the upper 30% VWAP-to-HOD zone, with forming bullish 5s MACD and liquidity gates. '
        'Closer confirmed swing/support initial stop; breakout plus holding close stop advancement; '
