...
CONFIGURATION_BINDINGS = (
    ...
    ConfigurationBindingDefinition("market_discovery.conditions", "market_discovery.rule_sets[].conditions[]", "condition", "condition_id", "editable_instance", ("left_field_ref", "left_interval", "comparator", "right_field_ref", "right_interval", "value", "enabled"), ("left_field_ref", "right_field_ref")),
