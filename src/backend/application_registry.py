...
def _query_plans() -> tuple[QueryPlanDefinition, ...]:
    ...
    return (
        ...
        QueryPlanDefinition(
            ...
            "news_gateway",
            "src.backend.canvas_preview_service:historical_company_news_projection",
            ("service://news-gateway/canonical-company-news",),
        ...
        QueryPlanDefinition(
            "sec.filing_asof.v1",
            "sec_gateway",
            "src.backend.canvas_preview_service:historical_sec_projection",
            ("service://sec-gateway/filings-v3", "q_live.id_sec_market_bridge_v3"),
