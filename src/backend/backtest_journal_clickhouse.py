...
def journal_clickhouse_client() -> Any:
    """Fail closed: the opaque ``arte.bt_*`` writer was retired."""
    raise RuntimeError(
        "The arte.bt_* journal was retired; fixed Backtest requires the typed "
        "arte trading-journal runtime and recovery cutover"
    )
