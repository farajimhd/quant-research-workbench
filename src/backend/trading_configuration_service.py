...
def _validate_strategy_lifecycle(
    ...
    if not routes and engine_parameters.get('hindsight_long_contract') != 'hindsight-long-1s-v1' and engine_parameters.get('historical_hod_contract') != 'historical-hod-1s-macd-5s-1' and engine_parameters.get('structural_recovery_contract') != 'v6-structural-recovery-1' and engine_parameters.get('macd_hod_contract') != 'macd-hod-100ms-1' and engine_parameters.get('macd_threshold_contract') != 'macd-threshold-100ms-1' and engine_parameters.get('macd_r3_contract') != 'macd-r3-100ms-1':
