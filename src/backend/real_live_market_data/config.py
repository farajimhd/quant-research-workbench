...
def market_gateway_config() -> MarketGatewayConfig:
    ...
    clickhouse = ClickHouseConfig(
        database=env_first("REAL_LIVE_CLICKHOUSE_DATABASE", "CLICKHOUSE_DATABASE", "TD__DATABASE__CLICKHOUSE__DATABASE", default="default"),
        endpoint_url=env_first("REAL_LIVE_CLICKHOUSE_URL", "CLICKHOUSE_URL", "TD__DATABASE__CLICKHOUSE__ENDPOINT_URL", default=DEFAULT_CLICKHOUSE_URL).rstrip("/"),
        password=env_first("REAL_LIVE_CLICKHOUSE_PASSWORD", "CLICKHOUSE_PASSWORD", "TD__DATABASE__CLICKHOUSE__PASSWORD", default=""),
        user=env_first("REAL_LIVE_CLICKHOUSE_USER", "CLICKHOUSE_USER", "TD__DATABASE__CLICKHOUSE__USER", default="default"),
    )
    massive = MassiveWebSocketConfig(
