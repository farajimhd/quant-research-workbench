...
DESCRIPTION = (
    ...
    'strictly greater than 2. Use the immediate overhead resistance when its midpoint '
    'is at least 2 ATR above the broken level; otherwise use the first resistance at '
    'least 2.5 ATR above it. A late entry beyond half the immediate gap advances the '
