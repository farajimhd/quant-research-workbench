...
SCANNER_FUNDAMENTAL_FIELDS = (
    ...
    "fundamental_revenue_change", "fundamental_revenue_growth_pct",
    "fundamental_earnings_change", "fundamental_earnings_growth_pct",
    "fundamental_share_change", "fundamental_share_growth_pct",
    ...
    *,
    ...
    for ticker, fundamental_rows in grouped.items():
        ...
        values: dict[str, Any] = {
            ...
            "fundamental_revenue_change": financial_card.get("revenue_change"),
            "fundamental_earnings_change": financial_card.get("income_change"),
            "fundamental_share_change": share_card.get("change"),
