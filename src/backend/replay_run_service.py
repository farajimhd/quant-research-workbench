...
class ReplayRunController:
    ...
    async def _observe_episode_candle(self, frame: ReplayDerivedFrame) -> None:
        ...
        if parameters.get('early_squeeze_breakout_contract') in ('early-squeeze-r1-100ms-v7', 'early-squeeze-r1-100ms-v8', 'early-squeeze-r1-price-gap-v9', 'early-squeeze-r1-price-high-v10', 'early-squeeze-r1-price-episode-v11', 'early-squeeze-r1-price-resistance-ceiling-v12', 'early-squeeze-r1-price-broken-resistance-ceiling-v13', 'early-squeeze-r1-price-green-close-ceiling-v14', 'early-squeeze-r1-price-macd-1s-episode-reentry-v15', 'early-squeeze-r1-price-dual-macd-reentry-v16', 'early-squeeze-r1-price-episode-target-continuity-v17', 'early-squeeze-r1-price-forming-episode-v18', 'early-squeeze-r1-price-confirmed-breakout-v19', 'early-squeeze-r1-price-volatility-chop-v20', 'early-squeeze-r1-price-midpoint-execution-v21') and frame.timeframe == '100ms':
    ...
    async def _process_strategy_market_event(self, event: MarketEvent) -> bool:
        ...
        if any(a.parameters.get('early_squeeze_breakout_contract') == 'early-squeeze-r1-price-midpoint-execution-v21'
               for a in ticker_assignments):
            line_sample = source_values.get('indicator.macd.line@1s', {})
            signal_sample = source_values.get('indicator.macd.signal@1s', {})
            if (line_sample.get('observed_at') == signal_sample.get('observed_at')
                    and line_sample.get('sample_kind') != 'forming'
                    and signal_sample.get('sample_kind') != 'forming'):
                base = replace(base, structural_detector_state={**(base.structural_detector_state or {}),
                    'macd_1s_evidence': dict(as_of=event.ts.isoformat(),
                        source_observed_at=line_sample.get('observed_at'),
                        line=line_sample.get('value'), signal=signal_sample.get('value'),
                        authority='latest-completed-qmd-1s')})
