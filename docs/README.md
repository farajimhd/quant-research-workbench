...
- [Benzinga Structured Rendering v2](data_contracts/benzinga_news_rendered_v2.md): shared historical/live structured renderer, certified cutover, audit, and article-level embeddings.
