...
def compact_event_from_mapping(payload: dict[str, Any]) -> CompactEvent | None:
    ...
    try:
        return CompactEvent(
            ...
            event_meta=int(payload["event_meta"]),
            ...
            condition_token_1=int(payload.get("condition_token_1", 0)),
            condition_token_2=int(payload.get("condition_token_2", 0)),
            condition_token_3=int(payload.get("condition_token_3", 0)),
            condition_token_4=int(payload.get("condition_token_4", 0)),
            condition_token_5=int(payload.get("condition_token_5", 0)),
