...
class ReferenceGatewayConfig:
    ...
    def from_env(cls, overrides: ReferenceGatewayConfigOverrides | None = None) -> "ReferenceGatewayConfig":
        ...
        return cls(
            ...
            daemon_child_timeout_seconds=env_float("REFERENCE_GATEWAY_DAEMON_CHILD_TIMEOUT_SECONDS", 0.0),
    ...
    def public_dict(self) -> dict[str, object]:
        return {
            ...
            "source_sync": {
                ...
                "ticker_event_inventory_frequency_seconds": self.ticker_event_inventory_frequency_seconds,
                "ticker_event_sync_frequency_seconds": self.ticker_event_sync_frequency_seconds,
                "ticker_event_sync_batch_size": self.ticker_event_sync_batch_size,
                "ticker_event_stale_after_days": self.ticker_event_stale_after_days,
                "ticker_event_request_min_interval_seconds": self.ticker_event_request_min_interval_seconds,
