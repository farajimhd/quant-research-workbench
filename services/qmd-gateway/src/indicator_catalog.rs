...
const INDICATOR_CATALOG: &[IndicatorCatalogEntry] = &[
    ...
    IndicatorCatalogEntry {
        ...
        persist_policy: PersistPolicy::IfSignalUses,
        status: ImplementationStatus::Implemented,
        inputs: &["bars", "session_context", "daily_bars", "estimated_luld"],
        fields: &[
            "structure_session_high",
            "structure_session_low",
            "structure_premarket_high",
            "structure_premarket_low",
            "structure_opening_range_high",
            "structure_opening_range_low",
            "structure_swing_high",
            "structure_swing_low",
            "structure_bos_price",
            "structure_bos_direction",
            "structure_choch_price",
            "structure_choch_direction",
            "structure_luld_upper",
            "structure_luld_lower",
            "structure_52_week_high",
            "structure_52_week_low",
            "structure_prior_month_high",
            "structure_prior_month_low",
            "structure_prior_month_close",
            "structure_volume_poc",
            "structure_nearest_round",
        ],
        typical_timeframes: BAR_TFS,
        storage_target: "live_market_indicators_if_enabled",
        rationale: "Defines whether a move is structurally meaningful enough for the scanner.",
    },
    IndicatorCatalogEntry {
        key: "shock_features",
