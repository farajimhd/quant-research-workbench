...
pub struct GatewayConfig {
    ...
    pub gap_fill_symbol_universe_column: String,
    pub gap_fill_symbol_universe_sql: String,
    pub gap_fill_symbol_universe_table: String,
...
impl GatewayConfig {
    pub fn from_env() -> Self {
        ...
        Self {
            ...
            gap_fill_symbol_universe_column: env_string(
                "QMD_GAP_FILL_SYMBOL_UNIVERSE_COLUMN",
                "ticker",
            ),
            gap_fill_symbol_universe_sql: env_string("QMD_GAP_FILL_SYMBOL_UNIVERSE_SQL", ""),
            gap_fill_symbol_universe_table: env_string("QMD_GAP_FILL_SYMBOL_UNIVERSE_TABLE", ""),
