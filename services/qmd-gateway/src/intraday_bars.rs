...
pub struct IntradayBarRow {
    ...
    pub(crate) label_resolution_us: i64,
    pub(crate) bucket_index: i64,
    pub(crate) bar_family: &'static str,
    pub(crate) open: f32,
    pub(crate) close: f32,
    high: f32,
    low: f32,
    pub(crate) size_sum: f64,
    size_open: f64,
    size_close: f64,
    size_high: f64,
    size_low: f64,
    ...
    pub(crate) last_event_timestamp_us: u64,
...
mod tests {
    ...
    fn quote_event(timestamp_us: u64, sequence: u64, bid: u32, ask: u32) -> LiveCompactEvent {
        LiveCompactEvent {
            ...
            event_meta: 0x06,
            execution_timestamp_us: timestamp_us,
            exchange_primary: 0,
            ...
            schema_version: crate::compact_event::LIVE_COMPACT_EVENT_SCHEMA_VERSION,
