...
pub(crate) mod tests {
    ...
    pub(crate) fn base_bar() -> BarRow {
        BarRow {
            ...
            trade_count: 100,
            vwap: 10.1,
            nbbo_consistent_volume: 10_000.0,
            nbbo_consistent_dollar_volume: 100_000.0,
            nbbo_consistent_trade_count: 100,
            nbbo_vwap: 10.1,
            ...
            price_change_1_bar: Some(0.1),
            price_change_3_bar: Some(0.2),
            price_change_5_bar: Some(0.3),
            price_change_1_bar_pct: Some(1.0),
            price_change_3_bar_pct: Some(2.0),
            price_change_5_bar_pct: Some(3.0),
            price_ratio_1_bar: Some(1.01),
            price_ratio_3_bar: Some(1.02),
            price_ratio_5_bar: Some(1.03),
            volume_change: Some(1_000.0),
            volume_change_pct: Some(11.11),
            volume_ratio: Some(1.1111),
            dollar_volume_change: Some(10_000.0),
            dollar_volume_change_pct: Some(11.11),
            dollar_volume_ratio: Some(1.1111),
            trade_count_change: Some(25.0),
            trade_count_change_pct: Some(33.33),
            trade_count_ratio: Some(1.3333),
            quote_count_change: Some(20.0),
            quote_count_change_pct: Some(20.0),
            quote_count_ratio: Some(1.2),
            trade_rate_change: Some(2.0),
            trade_rate_change_pct: Some(25.0),
            trade_rate_ratio: Some(1.25),
            volume_rate_change: Some(100.0),
            volume_rate_change_pct: Some(11.11),
            volume_rate_ratio: Some(1.1111),
            dollar_volume_rate_change: Some(1_000.0),
            dollar_volume_rate_change_pct: Some(11.11),
            dollar_volume_rate_ratio: Some(1.1111),
            quote_rate_change: Some(2.0),
            quote_rate_change_pct: Some(20.0),
            quote_rate_ratio: Some(1.2),
            avg_trade_size_change: Some(10.0),
            avg_trade_size_change_pct: Some(11.11),
            avg_trade_size_ratio: Some(1.1111),
            vwap_change: Some(0.1),
            vwap_change_pct: Some(1.0),
            vwap_ratio: Some(1.01),
            spread_close_change: Some(-0.01),
            spread_close_change_pct: Some(-16.67),
            spread_close_ratio: Some(0.8333),
            spread_bps_change: Some(-1.0),
            spread_bps_change_pct: Some(-16.67),
            spread_bps_ratio: Some(0.8333),
            buy_sell_volume_delta_change: Some(500.0),
