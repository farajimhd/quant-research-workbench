...
| `flow_structure_composite_score`, `flow_structure_composite_confidence`, `flow_structure_composite_bias`, `flow_structure_composite_reason` | Continuous short-horizon relationship between event-native flow and causal structural context. Inputs are confidence-weighted; agreement preserves confidence and conflict discounts it. | Canonical at each closed 100 ms observation; higher timeframes confidence-weight the non-overlapping canonical values. |
