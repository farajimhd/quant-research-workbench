...
class NewsGatewayConfig:
    ...
    bootstrap_trusted_coverage_start_utc: str
    ...
    def from_env(cls) -> "NewsGatewayConfig":
        ...
        return cls(
            ...
            bootstrap_trusted_coverage_start_utc=env_string("NEWS_BENZINGA_BOOTSTRAP_TRUSTED_COVERAGE_START_UTC", "2010-01-01T00:00:00Z"),
            ...
            body_v4_shadow_enabled=env_bool("NEWS_BENZINGA_BODY_V4_SHADOW_ENABLED", False),
            body_v4_shadow_end_utc=env_string("NEWS_BENZINGA_BODY_V4_SHADOW_END_UTC", ""),
            ...
            intelligence_enabled=env_bool(
                "TEXT_INTELLIGENCE_DISPATCH_ENABLED",
                env_bool("NEWS_INTELLIGENCE_DISPATCH_ENABLED", True),
            ),
            intelligence_url=env_string(
                "TEXT_INTELLIGENCE_URL",
                env_string("NEWS_INTELLIGENCE_URL", "http://127.0.0.1:8804"),
            ).rstrip("/"),
            intelligence_timeout_seconds=env_float(
                "TEXT_INTELLIGENCE_DISPATCH_TIMEOUT_SECONDS",
                env_float("NEWS_INTELLIGENCE_DISPATCH_TIMEOUT_SECONDS", 2.0),
            ),
        )
