...
pub struct NewsGatewayConfig {
    ...
    pub benzinga_attachment_table: String,
    pub benzinga_canonical_table: String,
    pub benzinga_event_table: String,
    pub benzinga_poll_interval_ms: u64,
    pub benzinga_text_table: String,
    pub benzinga_url_table: String,
...
impl NewsGatewayConfig {
    pub fn from_env() -> Self {
        ...
        Self {
            ...
            benzinga_attachment_table: env_string("NEWS_BENZINGA_ATTACHMENT_TABLE", "benzinga_news_attachment_v1"),
            benzinga_canonical_table: env_string("NEWS_BENZINGA_CANONICAL_TABLE", "benzinga_news_event_v1"),
            benzinga_event_table: env_string(
                "NEWS_BENZINGA_EVENT_TABLE",
                &env_string("NEWS_BENZINGA_CANONICAL_TABLE", "benzinga_news_event_v1"),
            ),
            benzinga_poll_interval_ms: env_u64("NEWS_BENZINGA_POLL_INTERVAL_MS", 5_000),
            benzinga_text_table: env_string("NEWS_BENZINGA_TEXT_TABLE", "benzinga_news_text_v1"),
            benzinga_url_table: env_string("NEWS_BENZINGA_URL_TABLE", "benzinga_news_url_v1"),
