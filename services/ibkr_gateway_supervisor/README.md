...
- alerts when fresh browser login is required
- provides an explicit Playwright login helper for the paper account
...
Login once with headed Playwright:
...
Playwright is only needed for `--login-once`:
