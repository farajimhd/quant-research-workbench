...
DEFAULT_ARGS: dict[str, str | int | float | bool] = {
    ...
    "learning-rate": 3e-4,
    "weight-decay": 0.01,
    "fast-summary-samples": 25000,
    "train-metric-window-samples": 250000,
    "validation-samples": 2000000,
    "validation-batches": 8,
    "checkpoint-latest-samples": 250000,
    "checkpoint-archive-samples": 2000000,
