...
def loader_config_from_v3(config: LoaderConfig) -> Any:
    ...
    return DailyIndexLoaderConfig(
        ...
        scanner_top_k=5,
        scanner_index_cache_entries=config.scanner_index_cache_entries,
        prefetch_scanner_indexes=config.prefetch_scanner_indexes,
        scanner_prefetch_workers=config.scanner_prefetch_workers,
