...
class ModelConfig:
    d_model: int = 256
    fusion_d_model: int = 0
    event_d_model: int = 0
    bar_d_model: int = 0
    text_d_model: int = 0
    xbrl_d_model: int = 0
    corporate_action_d_model: int = 0
    scanner_d_model: int = 0
    ...
    event_exchange_vocab_size: int = 256
    event_condition_vocab_size: int = 256
    event_use_local_conv: bool = True
    fusion_layers: int = 3
    fusion_heads: int = 8
    ...
    corporate_action_item_dim: int = 64
    corporate_action_category_dim: int = 8
    corporate_action_latents: int = 4
    corporate_action_attention_heads: int = 4
    corporate_action_action_type_vocab_size: int = 16
    corporate_action_dividend_type_vocab_size: int = 16
    corporate_action_currency_vocab_size: int = 64
    corporate_action_frequency_vocab_size: int = 64
