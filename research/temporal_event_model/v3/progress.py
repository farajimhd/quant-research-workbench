    ...
    rows.extend(
        _formatted_metric_rows(
            [
                ...
                ("frontier refs", metrics.get("frontier/selected_refs")),
                ("frontier tickers", metrics.get("frontier/selected_tickers")),
                ("frontier cap", metrics.get("frontier/cap_origins")),
                ("frontier capped", metrics.get("frontier/cap_reached")),
...
def _cache_state_table(metrics: Mapping[str, Any], *, empty_phase: str) -> Any:
    ...
    rows = _formatted_metric_rows(
        [
            ...
            ("frontier refs", metrics.get("frontier_selected_refs")),
            ("frontier tickers", metrics.get("frontier_selected_tickers")),
            ("frontier cap", metrics.get("frontier_cap_origins")),
            ("frontier capped", metrics.get("frontier_cap_reached")),
            ("frontier sec", metrics.get("frontier_cursor_seconds")),
