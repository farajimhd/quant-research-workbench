...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--external-request-min-interval-seconds", type=float, default=float(os.environ.get("NEWS_EXTERNAL_REQUEST_MIN_INTERVAL_SECONDS", "0.1")))
    parser.add_argument("--benzinga-request-min-interval-seconds", type=float, default=float(os.environ.get("NEWS_BENZINGA_REQUEST_MIN_INTERVAL_SECONDS", "0.1")))
    parser.add_argument("--sec-request-min-interval-seconds", type=float, default=float(os.environ.get("NEWS_SEC_REQUEST_MIN_INTERVAL_SECONDS", "0.1")))
