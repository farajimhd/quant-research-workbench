...
| Example Key | Meaning |
| --- | --- |
| `session_last_bid` | Latest bid price as of the origin. |
| `session_last_ask` | Latest ask price as of the origin. |
| `session_last_bid_size` | Latest bid size. |
| `session_last_ask_size` | Latest ask size. |
...
Derived quote fields such as midpoint and spread are intentionally not
materialized because they are deterministic from bid and ask.
