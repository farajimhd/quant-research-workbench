...
DISCOVERY_EPOCHS = 2
DEFAULT_SHARD_ROOT = Path(r"D:\TradingML\runtimes\bar_gpt\v1\offline_shards_v5")
...
def _trainer_command(
    ...
    *,
    ...
    return [
        sys.executable, "-B", "-m", "research.bar_gpt.v1.train",
        "--data-source", "offline",
...
def main(argv: Iterable[str] | None = None) -> int:
    ...
    manifest_path = output_root / "fixed_panels_v4.json"
    ...
    state_path = output_root / "campaign_state_v4.json"
    ...
    for index, run_key in enumerate(finalists, start=1):
        ...
        command = [
            sys.executable, "-B", "-m", "research.bar_gpt.v1.evaluate_discovery_checkpoint",
