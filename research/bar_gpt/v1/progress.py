...
TRAINING_OBJECTIVES: tuple[tuple[str, str, str], ...] = (
    ...
    ("AR direction", "train/loss_ar_direction", "loss"),
    ...
    ("Trade MAE", "train_trade_summary/mae_macro", "bps"),
...
VALIDATION_SCORECARD: tuple[tuple[str, str, str], ...] = (
    ...
    ("Trade MAE", "validation_trade_summary/mae_macro", "bps"),
    ...
    ("Trade neutral", "validation_trade_summary/neutral_macro", "percent"),
    ("AR neutral", "validation_ar_direction_neutral/neutral_fraction_macro", "percent"),
    ("Trade calibration", "validation_trade_summary/calibration_macro", "percent"),
