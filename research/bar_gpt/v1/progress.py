...
TRAINING_OBJECTIVES: tuple[tuple[str, str, str], ...] = (
    ...
    ("Horizon MCC", "train_direction/mcc_macro", "number"),
...
VALIDATION_SCORECARD: tuple[tuple[str, str, str], ...] = (
    ...
    ("Horizon MCC", "validation_direction/mcc_macro", "number"),
    ...
    ("Horizon neutral", "validation_direction_neutral/neutral_fraction_macro", "percent"),
