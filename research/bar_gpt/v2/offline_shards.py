...
from research.bar_gpt.v2.loader import BarGPTIterableDataset, month_units
...
def _run_main(args: argparse.Namespace, run_log: BuildRunLog | None) -> int:
    from research.bar_gpt.v2.train import _stream_config, preflight, sequential_coverage_counts
