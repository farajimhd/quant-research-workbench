...
from research.bar_gpt.v2.loader import ClickHouseBarStreamConfig
from research.bar_gpt.v2.offline_shards import _merge_view
from research.bar_gpt.v2.offline_shards import shard_compatibility_hash
from research.bar_gpt.v2.schema import FEATURE_NAMES
from research.bar_gpt.v2.shard_data_audit import _complete_sidecars, reconstruct_clickhouse_example
...
class SparsePaddingCompilerTest(unittest.TestCase):
    ...
    def test_clickhouse_reconstruction_uses_direct_event_authority(self) -> None:
        ...
        with patch(
            "research.bar_gpt.v2.shard_data_audit.DirectEventShardDataset",
            FakeDirectDataset,
        ):
