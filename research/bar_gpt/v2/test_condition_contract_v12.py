...
from research.bar_gpt.v2.loader import TickerInterval
from research.bar_gpt.v2.schema import FEATURE_INDEX, FEATURE_NAMES, ONE_SECOND_US
from research.bar_gpt.v2.targets import TARGET_NAMES, build_physical_horizon_targets
...
class ConditionContractV12Test(unittest.TestCase):
    ...
    def test_trailing_condition_carries_to_next_trade_session(self) -> None:
        ...
        from research.bar_gpt.v2.data import BarView
