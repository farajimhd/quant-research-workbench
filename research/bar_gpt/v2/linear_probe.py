...
from research.bar_gpt.v2.targets import TARGET_NAMES
...
def parse_args(argv: Iterable[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument("--output-root", default=r"D:\TradingML\runtimes\bar_gpt\v2\linear_probe")
...
def main(argv: Iterable[str] | None = None) -> int:
    ...
    run_name = args.run_name or f"bar-gpt-v2-probe-{time.strftime('%Y%m%d-%H%M%S')}"
