...
DEFAULT_OUTPUT_ROOT = Path(r"D:\TradingML\runtimes\bar_gpt\v2\model_comparison")
...
def comparison_run_name(model_size: str, run_stamp: str) -> str:
    ...
    return (
        f"bar-gpt-v2-epoch1-{model_size}-micro{run.microbatch}-"
...
def _launcher_command(
    ...
    *,
    ...
    command = [
        ...
        "-B",
        "-m",
        "research.bar_gpt.v2.run_train_model_comparison",
        "--model-size",
        model_size,
        "--run-stamp",
        run_stamp,
