...
def commands(args: argparse.Namespace) -> tuple[tuple[str, list[str]], ...]:
    ...
    build = [
        sys.executable, "-B", "-m", "research.bar_gpt.v2.run_build_offline_shards",
    ...
    structural_audit = [
        sys.executable, "-B", "-m", "research.bar_gpt.v2.audit_offline_shards",
    ...
    sampled_audit = [
        sys.executable, "-B", "-m", "research.bar_gpt.v2.run_audit_shard_data",
        "--root", str(args.output_root),
