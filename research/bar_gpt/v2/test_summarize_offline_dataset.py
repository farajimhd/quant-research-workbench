...
from research.bar_gpt.v2.summarize_offline_dataset import (
    BoundedDistribution,
    PreparedShardSample,
    _context_counts,
    _decode_feature,
...
from research.bar_gpt.v2.targets import AUTOREGRESSIVE_TARGET_NAMES
...
class OfflineDatasetSummaryTest(unittest.TestCase):
    ...
    def test_preparation_workers_are_concurrent_but_results_remain_ordered(self) -> None:
        ...
        with patch("research.bar_gpt.v2.summarize_offline_dataset._prepare_shard_sample", side_effect=prepare):
    ...
    def test_shard_preparation_failure_identifies_unit(self) -> None:
        ...
        with patch("research.bar_gpt.v2.summarize_offline_dataset.load_shard", side_effect=OSError("disk error")):
