...
from research.bar_gpt.v2.offline_shards import load_shard, load_shard_storage_config, materialize_block
...
DEFAULT_OUTPUT_ROOT = Path(r"D:\TradingML\runtimes\bar_gpt\v2\dataset_reports")
