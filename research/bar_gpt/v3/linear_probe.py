...
from research.bar_gpt.v3.data import PATHWAY_ID_BY_NAME, TIMEFRAME_US_BY_NAME, BarGPTBatch
...
from research.bar_gpt.v3.targets import TARGET_NAMES
...
def parse_args(argv: Iterable[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument("--output-root", default=r"D:\TradingML\runtimes\bar_gpt\v3\linear_probe")
...
def main(argv: Iterable[str] | None = None) -> int:
    ...
    run_name = args.run_name or f"bar-gpt-v3-probe-{time.strftime('%Y%m%d-%H%M%S')}"
