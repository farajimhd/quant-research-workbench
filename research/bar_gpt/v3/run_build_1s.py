...
from research.bar_gpt.v3.build_1s import PREVIOUS_COHORT_TABLE
...
DEFAULTS = {
    ...
    "runtime_root": r"D:\TradingML\runtimes\bar_gpt\v3\build_1s",
...
def parse_args(argv: list[str] | None = None) -> tuple[argparse.Namespace, list[str]]:
    parser = argparse.ArgumentParser(description="Workstation launcher for the BarGPT shared one-second ClickHouse build.")
