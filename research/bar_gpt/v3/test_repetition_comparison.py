...
from research.bar_gpt.v3.config import BAR_GPT_MODEL_COMPARISON_WANDB_PROJECT
from research.bar_gpt.v3.run_train_model_comparison import (
    COMPARISON_MANIFEST_NAME,
    COMPARISON_RUNS,
    trainer_argv as baseline_trainer_argv,
)
from research.bar_gpt.v3.run_train_repetition_comparison import (
    REPETITION_EPOCHS,
...
class RepetitionComparisonTests(unittest.TestCase):
    ...
    def test_nested_subset_is_deterministic_complete_and_distribution_bounded(self) -> None:
        ...
        with (
            patch(
                "research.bar_gpt.v3.run_train_repetition_comparison.REPETITION_TRAIN_ORIGINS",
                parent_origins // 4,
            ),
            patch(
                "research.bar_gpt.v3.run_train_repetition_comparison.SELECTION_CANDIDATE_SALTS",
                16,
            ),
            patch(
                "research.bar_gpt.v3.run_train_repetition_comparison.MAX_ABSOLUTE_SHARE_DRIFT",
                0.05,
            ),
        ):
    ...
    def test_all_repetition_runs_use_fresh_processes_sequentially(self) -> None:
        ...
        with patch(
            "research.bar_gpt.v3.run_train_repetition_comparison.subprocess.run",
    ...
    def test_launcher_command_is_separate_from_original_comparison(self) -> None:
        ...
        self.assertIn("research.bar_gpt.v3.run_train_repetition_comparison", command)
        self.assertNotIn("research.bar_gpt.v3.run_train_model_comparison", command)
