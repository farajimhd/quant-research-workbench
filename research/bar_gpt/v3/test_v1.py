...
from research.bar_gpt.v3.build_1s import (
    BuildReporter,
...
from research.bar_gpt.v3.trade_correction_overlay import (
...
from research.bar_gpt.v3.cohort import (
    BAR_GPT_COHORT_2TB,
...
from research.bar_gpt.v3.data import BarView, causal_asof_indices, densify_one_second_view, horizon_target_indices, rollup_intraday_view
from research.bar_gpt.v3.features import MODEL_FEATURE_NAMES, project_stationary_features
from research.bar_gpt.v3.direct_event_shards import direct_trade_bar_query
from research.bar_gpt.v3.model import (
    BarGPTV3,
    CausalSelfAttention,
    RMSNorm,
    _fused_linear_group,
...
from research.bar_gpt.v3.run_build_1s import main as launcher_main
from research.bar_gpt.v3.run_build_1s import parse_args as parse_launcher_args
from research.bar_gpt.v3.run_build_1s_aliases import parse_args as parse_alias_launcher_args
...
class BuilderSqlTest(unittest.TestCase):
    ...
    def test_cpu_causal_attention_uses_compatible_explicit_gqa(self) -> None:
        ...
        with patch(
            "research.bar_gpt.v3.model.F.scaled_dot_product_attention",
...
class BuildReporterTest(unittest.TestCase):
    ...
    def reporter() -> BuildReporter:
        reporter = BuildReporter(
            report_path=Path(r"D:\TradingML\runtimes\bar_gpt\v3\build_1s\test\build.jsonl"),
            total_days=2_922,
            interactive=True,
        )
...
class ModelContractTest(unittest.TestCase):
    ...
    def test_fused_execution_preserves_legacy_parameter_keys(self) -> None:
        ...
        BarGPTV3(config).load_state_dict(state, strict=True)
    ...
    def test_full_fused_model_matches_independent_projection_reference(self) -> None:
        ...
        actual_model = BarGPTV3(config).eval()
        ...
        with patch(
            "research.bar_gpt.v3.model._fused_linear_group",
        ...
        def tensors(output):
            ...
            values.extend(output.autoregressive_gap_logits.values())
            values.extend((
