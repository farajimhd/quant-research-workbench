...
from research.bar_gpt.v3.offline_shards import OfflineBlockRef, load_shard, materialize_block, shard_path
...
DEFAULT_OUTPUT_ROOT = Path(r"D:\TradingML\runtimes\bar_gpt\v3\return_class_analysis")
...
def parse_args(argv: Iterable[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Audit the evaluation-only BarGPT v3 three-class 1 bp return labels "
