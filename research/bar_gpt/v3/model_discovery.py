...
DEFAULT_OUTPUT_ROOT = Path(r"D:\TradingML\runtimes\bar_gpt\v3\model_discovery")
...
def _trainer_command(
    ...
    *,
    ...
    return [
        sys.executable, "-B", "-m", "research.bar_gpt.v3.train",
        "--data-source", "offline",
...
def main(argv: Iterable[str] | None = None) -> int:
    ...
    for index, run_key in enumerate(finalists, start=1):
        ...
        command = [
            sys.executable, "-B", "-m", "research.bar_gpt.v3.evaluate_discovery_checkpoint",
