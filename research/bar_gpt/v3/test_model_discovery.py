...
from research.bar_gpt.v3.model_discovery_final_validation import (
...
from research.bar_gpt.v3.train import _wandb_metric_key, parse_args
...
class ModelDiscoveryContractTest(unittest.TestCase):
    ...
    def test_block_index_cache_avoids_reopening_completed_shards(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as directory:
            ...
            with patch(
                "research.bar_gpt.v3.model_discovery.load_shard_metadata",
                return_value=shard,
            ):
    ...
    def test_explicit_block_stream_is_identity_checked_and_resumable(self) -> None:
        ...
        with patch("research.bar_gpt.v3.offline_shards.load_shard", return_value={}), patch(
            "research.bar_gpt.v3.offline_shards.materialize_block", side_effect=materialize
        ):
            blocks = list(dataset)
