...
from research.bar_gpt.v3.profile_train import ProfileCandidate, _data as profile_data, parse_args as profile_args
from research.bar_gpt.v3.run_train import default_argv
from research.bar_gpt.v3.train import build_config, parse_args as train_args
