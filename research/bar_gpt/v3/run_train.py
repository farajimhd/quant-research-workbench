...
from research.bar_gpt.v3.train import main
...
DEFAULT_ARGS: dict[str, str] = {
    ...
    "--epochs": "2",
    "--global-validation-interval-samples": "500000000",
    ...
    "--monitor-evaluation-origins": "250000",
    "--checkpoint-validation-evaluations": "1",
    "--logging-samples": "1000000",
    "--training-metrics-interval-samples": "5000000",
    "--epoch-train-evaluation-origins": "1000000",
    "--amp-dtype": "bf16",
...
if __name__ == "__main__":
    ...
    command = [sys.executable, "-B", "-m", "research.bar_gpt.v3.train", *args]
