...
from research.bar_gpt.v3.benchmark_loader import _make_data_config, _percentile, parse_args
from research.bar_gpt.v3.benchmark_offline_loader import (
...
from research.bar_gpt.v3.run_benchmark_loader import DEFAULT_ARGS
...
class LoaderBenchmarkContractTest(unittest.TestCase):
    ...
    def test_fixed_workloads_are_disjoint_full_batches_on_shared_units(self) -> None:
        ...
        with patch("research.bar_gpt.v3.benchmark_offline_loader._unit_block_refs", side_effect=refs):
