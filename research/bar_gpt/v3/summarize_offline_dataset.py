...
from research.bar_gpt.v3.offline_shards import load_shard, load_shard_storage_config, materialize_block
...
DEFAULT_OUTPUT_ROOT = Path(r"D:\TradingML\runtimes\bar_gpt\v3\dataset_reports")
...
def _render(report: dict[str, Any], output: Path, console: Console) -> None:
    ...
    console.print(Panel.fit(
        ...
        title="BarGPT v12 offline shards", border_style="cyan",
    ))
