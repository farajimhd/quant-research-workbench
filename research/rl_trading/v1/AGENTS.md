...
- Market observations and label price action come only from the certified `arte.bars_v1` and `arte.indicators_v1` products. Do not read event tables, QMD History, flatfiles, quote tables, or alternative bars.
