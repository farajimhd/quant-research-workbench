...
python -B research/rl_trading/v1/build_phase1.py benchmark --date 2026-08-21 --tickers AAPL SUGP
python -B research/rl_trading/v1/build_phase1.py run --start 2026-08-18 --end 2026-09-18
"""
import os
...
from research.rl_trading.v1.common import bounds, digest, NY, exclusive, file_hash, verified
...
from research.rl_trading.v1.campaign import STOP, phase2_process

SOURCES = tuple(f'research/rl_trading/v1/{name}.py' for name in (
    'build_phase1','build_phase2','build_phase3','phase1_labels','arte_source',
    'arte_sql','common','phase2_values','market_values','phase3_search','campaign')) + (
    'src/market_engine/hindsight_batch.py','src/market_engine/level_book_store.py',
    'pipelines/market_sip/events/trade_reporting_flags.py')
