...
from research.masked_event_model.v8.train import build_scheduler, move_batch, resolve_amp_dtype
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Replay v8 training from a checkpoint and inspect the backward pass. "
...
def main() -> None:
    ...
    print("v8 gradient replay debugger", flush=True)
