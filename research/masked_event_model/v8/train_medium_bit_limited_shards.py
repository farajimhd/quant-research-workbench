...
from research.masked_event_model.v8.train import main as train_main  # noqa: E402
...
DEFAULTS: dict[str, Any] = {
    ...
    "wandb_mode": "online",
    "wandb_run_name": "v8-medium-event-token-emb32-bs4096-10shards",
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train v8 event-token MAE on 10 sample-cache shards with one validation shard slice.")
...
def main() -> None:
    ...
    print("=" * 96, flush=True)
    print("v8 medium event-token limited-shard training", flush=True)
