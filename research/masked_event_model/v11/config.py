...
class MaskConfig:
    ...
    # v11 keeps the fixed-mask schedule: every training batch masks the same
    # 70% of event tokens so architecture changes can be compared cleanly.
...
class ModelConfig:
    ...
    event_embedding_features: int = 2
...
class TrainConfig:
    ...
    wandb_project: str = "June2026-event-token-mae-v11-tokenwise-memory2"
