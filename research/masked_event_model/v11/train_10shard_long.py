...
DEFAULTS: dict[str, Any] = {
    ...
    "wandb_mode": "online",
    "wandb_run_name": "v11-tokenwise-f2-memory2-fixedmask070-emb32-bs4096-10shards",
...
PROFILED_TRAINING_PATH = (
    "v11 event-token MAE, masked-query cross-attention decoder, "
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Long v11 pretraining over 10 sample-cache shards. Defaults target the "
...
def print_plan(
    ...
    print("v11 long pretraining over sample-cache shards", flush=True)
