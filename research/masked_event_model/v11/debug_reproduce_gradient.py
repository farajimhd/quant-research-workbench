...
from research.masked_event_model.v11.masking import build_event_masks
from research.masked_event_model.v11.model import EventTokenMaskedAutoencoder
from research.masked_event_model.v11.train import build_scheduler, move_batch, resolve_amp_dtype
...
DEFAULT_RUN_DIR = Path(
    r"D:\TradingML\runtimes\masked_event_model\v11\pretrain"
    r"\v11-tokenwise-f2-memory2-fixedmask070-emb32-bs4096-10shards"
)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Replay v11 training from a checkpoint and inspect the backward pass. "
...
def main() -> None:
    ...
    print("v11 gradient replay debugger", flush=True)
