...
DEFAULTS: dict[str, Any] = {
    ...
    "wandb_mode": "online",
    "wandb_run_name": "v5-medium-newdecoder-emb32-bs4096-10shards-long",
    "warm_start_checkpoint": "",
}

VALIDATION_BATCHES = 20
PROFILED_TRAINING_PATH = (
    "v5 event-token MAE, masked-query cross-attention decoder, "
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Long v5 pretraining over 10 sample-cache shards. Defaults target the "
    ...
    values.update(
        {
            ...
            # Keep interleave disabled. In v4/v5 testing, interleave retained
...
def print_plan(
    ...
    print("v5 long pretraining over sample-cache shards", flush=True)
