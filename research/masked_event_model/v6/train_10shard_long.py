...
DEFAULTS: dict[str, Any] = {
    ...
    "wandb_mode": "online",
    "wandb_run_name": "v6-medium-newdecoder-emb32-bs4096-10shards-lr2e4-guarded",
    "warm_start_checkpoint": "",
}

VALIDATION_BATCHES = 20
PROFILED_TRAINING_PATH = (
    "v6 event-token MAE, masked-query cross-attention decoder, "
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Long v6 pretraining over 10 sample-cache shards. Defaults target the "
...
def print_plan(
    ...
    print("v6 long pretraining over sample-cache shards", flush=True)
