...
from research.masked_event_model.v6.train import main as train_main  # noqa: E402
...
DEFAULTS: dict[str, Any] = {
    ...
    "wandb_mode": "online",
    "wandb_run_name": "v6-medium-event-token-emb32-bs4096-10shards",
    "warm_start_checkpoint": "",
}

PROFILED_TRAINING_PATH = "v6 event-token MAE medium emb32 bs4096 compile-enabled, shard-cycle scheduler, no interleave"
VALIDATION_BATCHES = 8


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train v6 event-token MAE on 10 sample-cache shards with one validation shard slice.")
...
def main() -> None:
    ...
    print("=" * 96, flush=True)
    print("v6 medium event-token limited-shard training", flush=True)
