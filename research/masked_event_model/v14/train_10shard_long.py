...
DEFAULTS: dict[str, Any] = {
    ...
    "wandb_mode": "online",
    "wandb_run_name": "v14-bridgeactivations-nodecoderacts-fixedmask070-emb32-bs4096-10shards",
...
PROFILED_TRAINING_PATH = (
    "v14 event-token MAE, masked-query cross-attention decoder, "
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Long v14 pretraining over 10 sample-cache shards. Defaults target the "
...
def print_plan(
    ...
    print("v14 long pretraining over sample-cache shards", flush=True)
