...
class MaskConfig:
    ...
    # v14 keeps v13's fixed-mask schedule so the decoder-activation ablation
    # does not also change the visible/masked event distribution.
...
class TrainConfig:
    ...
    wandb_project: str = "June2026-event-token-mae-v14-bridge-activations"
