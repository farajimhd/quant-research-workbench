...
from research.masked_event_model.v14.train import build_scheduler, move_batch, resolve_amp_dtype
...
DEFAULT_RUN_DIR = Path(
    r"D:\TradingML\runtimes\masked_event_model\v14\pretrain"
    r"\v14-bridgeactivations-nodecoderacts-fixedmask070-emb32-bs4096-10shards"
)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Replay v14 training from a checkpoint and inspect the backward pass. "
...
def main() -> None:
    ...
    print("v14 gradient replay debugger", flush=True)
