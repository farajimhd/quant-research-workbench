...
DEFAULT_PRETRAIN_OUTPUT_ROOT = Path(r"D:\TradingML\runtimes\masked_event_model\v22\pretrain_capacity_tests")
...
DEFAULT_RUN_PREFIX = "v22-capacity-1shard5ep"
...
def main() -> int:
    ...
    print("v22 grouped branch-concat bottleneck probe", flush=True)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Pretrain the v22 grouped branch-concat bottleneck on one x-only shard, "
