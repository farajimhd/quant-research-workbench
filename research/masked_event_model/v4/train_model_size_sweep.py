...
from research.masked_event_model.v4.config import TrainConfig  # noqa: E402
from research.masked_event_model.v4.train import JOB_TYPE, MODEL_FAMILY, MODEL_VERSION  # noqa: E402
...
def build_train_command(args: argparse.Namespace, run: SweepRun) -> list[str]:
    ...
    command = [
        sys.executable,
        "-u",
        str(REPO_ROOT / "research" / "masked_event_model" / "v4" / "train.py"),
        "--data-source",
        "sample_cache",
        "--sample-cache-root",
        args.cache_root,
