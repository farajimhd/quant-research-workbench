...
DEFAULT_CHECKPOINT = Path(
    ...
    r"\v29-fullpretrain-dualcache-headerrecon-emb32-bs8192-lr4e4-1epoch-freshrng"
...
DEFAULT_PROBE_OUTPUT_ROOT = Path(r"D:\TradingML\runtimes\temporal_event_model\v1\cache_price_probe_v29")
DEFAULT_WANDB_PROJECT = "June2026-event-encoder-linear-probes"
DEFAULT_RUN_NAME = "v1-cache-probe-v29-dualcache-step43731-1train1val-5ep-bs8192"


def main() -> int:
    parser = argparse.ArgumentParser(
        description=(
            "Run a temporal v1 linear probe on the latest v29 dual-cache "
            "pretraining checkpoint. The v29 encoder is frozen; only the probe "
            "head is trained."
        )
    )
    ...
    print("v29 latest-checkpoint temporal linear probe", flush=True)
