...
class MaskConfig:
    ...
    # v29 keeps v25's fixed event-mask schedule and adds one isolated change:
    ...
    # Kept for CLI/config compatibility with older versions. v29 does not flip
...
class ModelConfig:
    ...
    # Accepted for launcher compatibility with earlier versions. v29 ignores
    # this value because reconstruction uses a per-masked-event MLP decoder.
    decoder_layers: int = 2
    ffn_mult: int = 4
    dropout: float = 0.08
    # v29 keeps the v25 decoder precision default.
...
class TrainConfig:
    ...
    wandb_project: str = "June2026-event-token-mae-v29-header-mask"
