...
from research.masked_event_model.v29.config import LossConfig, MaskConfig, ModelConfig
from research.masked_event_model.v29.losses import decode_masked_event_semantics, masked_event_bce_loss, masked_event_semantic_metrics, unpack_bits
from research.masked_event_model.v29.masking import build_event_masks
...
def test_forward_and_encode_shapes() -> None:
    ...
    masks = build_event_masks(event_bytes, mask_config)
