...
from research.masked_event_model.v25.train_full_pretrain import (  # noqa: E402
...
MIXED_RUN_CHECKPOINT = (
    ...
    r"\v25-fullpretrain-mixedcache-fixedmask070-emb32-bs8192-lr4e4-3epochs-freshrng-from-step260352"
...
DEFAULTS.update(
    {
        ...
        "wandb_run_name": "v25-fullpretrain-xonly100-fixedmask070-emb32-bs8192-lr4e4-3epochs-freshrng-from-mixed-latest",
    }
)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Continue v25 full pretraining from the latest mixed-cache checkpoint, "
...
def print_plan(values: dict[str, Any], train_shards, validation_shards, validation_batches: int, steps_per_epoch: int, argv: list[str]) -> None:
    ...
    print("v25 x-only full pretraining continuation", flush=True)
