...
DEFAULT_CHECKPOINT = Path(
    ...
    r"\v25-fullpretrain-dualcache-headerrecon-emb32-bs8192-lr4e4-1epoch-freshrng"
...
DEFAULT_PROBE_OUTPUT_ROOT = Path(r"D:\TradingML\runtimes\temporal_event_model\v1\cache_price_probe_v25")
DEFAULT_WANDB_PROJECT = "June2026-event-encoder-linear-probes"
DEFAULT_RUN_NAME = "v1-cache-probe-v25-dualcache-step43731-1train1val-5ep-bs8192"


def main() -> int:
    parser = argparse.ArgumentParser(
        description=(
            "Run a temporal v1 linear probe on the latest v25 dual-cache "
            "pretraining checkpoint. The v25 encoder is frozen; only the probe "
            "head is trained."
        )
    )
    ...
    print("v25 latest-checkpoint temporal linear probe", flush=True)
