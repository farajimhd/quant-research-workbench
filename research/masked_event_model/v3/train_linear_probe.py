...
from research.masked_event_model.v3.config import DataConfig, ModelConfig, ProbeConfig, TrainConfig
...
EXPERIMENT_VERSION = "mem-v3-linear-probe"
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description="Train a linear probe on a frozen masked event v3 checkpoint.")
...
if __name__ == "__main__":
    try:
        ...
        print("*** FATAL masked_event_model.v3.train_linear_probe error. Full traceback:", flush=True)
        traceback.print_exc()
        raise
