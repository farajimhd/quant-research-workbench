...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train v20 event-token MAE on 10 sample-cache shards with one validation shard slice.")
...
def main() -> None:
    ...
    print("=" * 96, flush=True)
    print("v20 medium event-token limited-shard training", flush=True)
