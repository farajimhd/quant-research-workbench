...
DEFAULT_PRETRAIN_OUTPUT_ROOT = Path(r"D:\TradingML\runtimes\masked_event_model\v20\pretrain_capacity_tests")
...
def main() -> int:
    ...
    print("v20 embedding-dimension / bottleneck-precision probe", flush=True)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Sequentially pretrain v20 embedding/precision variants on one x-only shard, "
