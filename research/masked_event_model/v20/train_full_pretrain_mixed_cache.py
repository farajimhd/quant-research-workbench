...
SOURCE_CHECKPOINT = (
    ...
    r"\v20-fullpretrain-sharddecay-fixedmask070-emb32-bs8192-lr1e4-epoch09-shard095-continue5epochs"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Start v20 full pretraining from the step-260352 checkpoint over a "
...
def print_plan(
    ...
    print("v20 mixed-cache full pretraining", flush=True)
