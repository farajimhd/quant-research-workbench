...
DEFAULTS: dict[str, Any] = {
    ...
    "wandb_mode": "online",
    "wandb_run_name": "v26-mlpdecoder-fixedmask070-emb32-bs8192-10shards",
...
PROFILED_TRAINING_PATH = (
    "v26 event-token MAE, v12-style per-masked-event MLP decoder, "
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Long v26 pretraining over 10 sample-cache shards. Defaults target the "
...
def print_plan(
    ...
    print("v26 long pretraining over sample-cache shards", flush=True)
