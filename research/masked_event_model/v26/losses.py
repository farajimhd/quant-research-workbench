...
from research.masked_event_model.v26.config import LossConfig
from research.masked_event_model.v26.model import EventMAEOutput
...
def masked_event_bce_loss(
    ...
    *,
    ...
    target_header_bytes = output.target_header_uint8
    target_header_bits = unpack_bits(target_header_bytes).to(dtype=header_logits.dtype, device=header_logits.device)
    ...
    metrics = {
        ...
        "pretrain/loss_header_terms_per_sample": float(HEADER_BITS_PER_SAMPLE),
    ...
    with torch.no_grad():
        ...
        header_hard_bytes = pack_bits(header_hard_bits)
        ...
        header_exact = (header_hard_bytes == target_header_bytes.long()).float().mean()
        ...
        metrics.update(
            ...
            "pretrain/header_byte_exact_acc_pct": float(header_exact.detach().cpu() * 100.0),
            ...
            "mask/header_bytes": float(target_header_bytes.numel()),
            }
        )
