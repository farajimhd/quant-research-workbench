...
from research.masked_event_model.v26.train import main as train_main  # noqa: E402
...
DEFAULTS: dict[str, Any] = {
    ...
    "wandb_mode": "online",
    "wandb_run_name": "v26-fullpretrain-sharddecay-fixedmask070-emb32-bs8192-lr1e4-epoch09-shard095-continue5epochs",
    "amp_initial_scale": 1024.0,
    "amp_overflow_fatal_threshold": 8,
    "float32_matmul_precision": "high",
    "repeatable_randomness": False,
    "warm_start_checkpoint": (
        r"\\DESKTOP-SAAI85T\Workstation-D\TradingML\runtimes\masked_event_model\\v26\pretrain"
        r"\v26-fullpretrain-sharddecay-fixedmask070-emb32-bs8192-3epochs\checkpoints\checkpoint_latest.pt"
    ),
}

VALIDATION_BATCHES = DEFAULTS["sample_cache_validation_max_shards"]
PROFILED_TRAINING_PATH = (
    "v26 full pretraining, v12-style per-masked-event MLP decoder, fixed-grid bottleneck, "
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Full v26 pretraining over the larger event sample cache. By default it "
...
def print_plan(values: dict[str, Any], train_shards, validation_shards, validation_batches: int, steps_per_epoch: int, argv: list[str]) -> None:
    ...
    print("v26 full pretraining over sample-cache shards", flush=True)
