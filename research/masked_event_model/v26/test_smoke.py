...
from research.masked_event_model.v26.config import LossConfig, MaskConfig, ModelConfig
from research.masked_event_model.v26.losses import decode_masked_event_semantics, masked_event_bce_loss, masked_event_semantic_metrics, unpack_bits
from research.masked_event_model.v26.masking import build_event_masks
...
def test_forward_and_encode_shapes() -> None:
    ...
    assert output.header_bit_logits.shape == (batch, 14, 8)
    ...
    target_header_bits = unpack_bits(output.target_header_uint8).to(dtype=output.header_bit_logits.dtype)
    ...
    assert embedding.shape == (batch, 3, 8)
