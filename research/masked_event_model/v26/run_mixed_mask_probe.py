...
DEFAULT_PRETRAIN_OUTPUT_ROOT = Path(r"D:\TradingML\runtimes\masked_event_model\v26\pretrain_mask_schedule_tests")
DEFAULT_PROBE_OUTPUT_ROOT = Path(r"D:\TradingML\runtimes\temporal_event_model\v1\cache_price_probe_v26_mask_tests")
...
DEFAULT_RUN_PREFIX = "v26-mixedmask-emb32-1shard5ep"
...
def main() -> int:
    ...
    print("v26 mixed-mask emb32 pretrain + linear probe", flush=True)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Train v26 emb32 with a mixed event-mask schedule on one pretraining shard for 5 epochs, "
