...
from research.masked_event_model.v12.masking import build_event_masks
from research.masked_event_model.v12.model import EventTokenMaskedAutoencoder
from research.masked_event_model.v12.train import build_scheduler, move_batch, resolve_amp_dtype
...
DEFAULT_RUN_DIR = Path(
    r"D:\TradingML\runtimes\masked_event_model\v12\pretrain"
    r"\v12-unweighted-fixedmask070-emb32-bs4096-unweightedmean-bf16-actuallrschedulerendofshard"
)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Replay v12 training from a checkpoint and inspect the backward pass. "
...
def main() -> None:
    ...
    print("v12 gradient replay debugger", flush=True)
