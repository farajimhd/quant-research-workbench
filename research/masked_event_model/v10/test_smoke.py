...
from research.masked_event_model.v10.config import LossConfig, MaskConfig, ModelConfig
from research.masked_event_model.v10.losses import decode_masked_event_semantics, masked_event_bce_loss, masked_event_semantic_metrics, unpack_bits
...
def test_forward_and_encode_shapes() -> None:
    ...
    assert embedding.shape == (batch, 2 + events, 1)
    ...
    assert standalone_embedding.shape == (batch, 2 + events, 1)
