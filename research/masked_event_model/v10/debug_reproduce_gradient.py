...
from research.masked_event_model.v10.masking import build_event_masks
from research.masked_event_model.v10.model import EventTokenMaskedAutoencoder
from research.masked_event_model.v10.train import build_scheduler, move_batch, resolve_amp_dtype
...
DEFAULT_RUN_DIR = Path(
    r"D:\TradingML\runtimes\masked_event_model\v10\pretrain"
    r"\v10-tokenwise-f1-fixedmask070-emb32-bs4096-10shards"
)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Replay v10 training from a checkpoint and inspect the backward pass. "
...
def main() -> None:
    ...
    print("v10 gradient replay debugger", flush=True)
