...
DEFAULTS: dict[str, Any] = {
    ...
    "wandb_mode": "online",
    "wandb_run_name": "v9-unweighted-fixedmask070-emb32-bs4096-10shards",
...
PROFILED_TRAINING_PATH = (
    "v9 event-token MAE, masked-query cross-attention decoder, "
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Long v9 pretraining over 10 sample-cache shards. Defaults target the "
...
def print_plan(
    ...
    print("v9 long pretraining over sample-cache shards", flush=True)
