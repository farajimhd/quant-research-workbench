...
DEFAULT_RUN_PREFIX = "v24-residualdecoder-1shard5ep"
...
def main() -> int:
    ...
    print("v24 residual-decoder bottleneck benchmark", flush=True)
...
def parse_args() -> tuple[argparse.Namespace, list[str]]:
    parser = argparse.ArgumentParser(
        description=(
            "Run the single v24 residual-decoder comparison: emb32 BF16 "
