...
DEFAULTS: dict[str, Any] = {
    ...
    "compile_model": True,
    "wandb_project": "June2026-event-token-mae-v24-residual-decoder",
    "wandb_entity": "mehdifaraji",
    "wandb_mode": "online",
    "wandb_run_name": "v24-residualdecoder-fixedmask070-emb32-bs8192-10shards",
...
PROFILED_TRAINING_PATH = (
    "v24 event-token MAE, residual per-masked-event MLP decoder, "
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Long v24 pretraining over 10 sample-cache shards. Defaults target the "
...
def print_plan(
    ...
    print("v24 long pretraining over sample-cache shards", flush=True)
    ...
    print(
        ...
        f"enc{values['encoder_layers']} decoder=per_masked_event_residual_mlp "
