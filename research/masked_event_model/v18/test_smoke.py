...
from research.masked_event_model.v18.config import LossConfig, MaskConfig, ModelConfig
from research.masked_event_model.v18.losses import decode_masked_event_semantics, masked_event_bce_loss, masked_event_semantic_metrics, unpack_bits
...
def test_forward_and_encode_shapes() -> None:
    ...
    event_states = model.encode_events(header, event_bytes)
    assert event_states.shape == (batch, events, 32)
