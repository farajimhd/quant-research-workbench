...
DEFAULTS: dict[str, Any] = {
    "cache_root": r"D:\market-data\prepared\event_sample_cache\cache_20260611_195259",
    "run_prefix": "v18-focused-fixedlr-profile",
    "steps": 200,
    "learning_rate": 2e-4,
    "scheduler": "none",
    "wandb_project": "June2026-event-token-mae-v18-variation-profile",
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description=(
            "Run five focused v18 profile variations sequentially. Each variation "
    ...
    command = [
        sys.executable,
        "-u",
        str(REPO_ROOT / "research" / "masked_event_model" / "v18" / "train_model_size_sweep.py"),
        "--profile-set",
        "focused",
        "--steps",
        str(known.steps),
    ...
    print("=" * 96, flush=True)
    print("v18 focused variation profile", flush=True)
