...
class MaskConfig:
    ...
    # v18 keeps v9's fixed-mask schedule: every training batch masks the same
...
class ModelConfig:
    ...
    ffn_mult: int = 4
    dropout: float = 0.08
    # v18 is the explicit low-cost MLP decoder experiment, so its default keeps
...
class TrainConfig:
    ...
    wandb_project: str = "June2026-event-token-mae-v18-mlp-decoder"
