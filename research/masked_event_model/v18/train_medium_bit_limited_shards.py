...
from research.masked_event_model.v18.train import main as train_main  # noqa: E402
...
DEFAULTS: dict[str, Any] = {
    ...
    "device": "cuda",
    "compile_model": True,
    "wandb_project": "June2026-event-token-mae-v18-mlp-decoder",
    "wandb_entity": "mehdifaraji",
    "wandb_mode": "online",
    "wandb_run_name": "v18-mlpdecoder-medium-event-token-emb32-bs4096-10shards",
    "warm_start_checkpoint": "",
}

PROFILED_TRAINING_PATH = "v18 event-token MAE medium emb32 bs4096 compile-enabled, shard-cycle scheduler, no interleave"
VALIDATION_BATCHES = 8


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train v18 event-token MAE on 10 sample-cache shards with one validation shard slice.")
    ...
    parser.add_argument("--perceiver-latent-tokens", type=int, default=DEFAULTS["perceiver_latent_tokens"])
...
def main() -> None:
    ...
    values.update(
        {
            ...
            "batch_size": batch_size,
            "perceiver_latent_tokens": int(args.perceiver_latent_tokens),
    ...
    print("=" * 96, flush=True)
    print("v18 medium event-token limited-shard training", flush=True)
