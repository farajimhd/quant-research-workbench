...
DEFAULTS: dict[str, Any] = {
    ...
    "wandb_mode": "online",
    "wandb_run_name": "v18-mlpdecoder-fixedmask070-emb32-bs4096-10shards",
...
PROFILED_TRAINING_PATH = (
    "v18 event-token MAE, per-masked-event MLP decoder, "
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Long v18 pretraining over 10 sample-cache shards. Defaults target the "
...
def print_plan(
    ...
    print("v18 long pretraining over sample-cache shards", flush=True)
    ...
    print(
        f"model=d{values['d_model']} emb{values['embedding_dim']} perceiver_latents={values['perceiver_latent_tokens']} "
