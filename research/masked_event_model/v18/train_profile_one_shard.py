...
DEFAULTS: dict[str, Any] = {
    ...
    "wandb_mode": "disabled",
    "wandb_run_name": "v18-one-shard-profile",
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Profile v18 training on one sample-cache shard.")
...
def main() -> None:
    ...
    values["perceiver_latent_tokens"] = args.perceiver_latent_tokens
