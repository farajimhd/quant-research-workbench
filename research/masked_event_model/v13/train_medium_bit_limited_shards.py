...
from research.masked_event_model.v13.train import main as train_main  # noqa: E402
...
DEFAULTS: dict[str, Any] = {
    ...
    "device": "cuda",
    "compile_model": True,
    "wandb_project": "June2026-event-token-mae-v13-activations",
    "wandb_entity": "mehdifaraji",
    "wandb_mode": "online",
    "wandb_run_name": "v13-activations-medium-event-token-emb32-bs4096-10shards",
    "warm_start_checkpoint": "",
}

PROFILED_TRAINING_PATH = "v13 event-token MAE medium emb32 bs4096 compile-enabled, shard-cycle scheduler, no interleave"
VALIDATION_BATCHES = 8


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train v13 event-token MAE on 10 sample-cache shards with one validation shard slice.")
...
def main() -> None:
    ...
    print("=" * 96, flush=True)
    print("v13 medium event-token limited-shard training", flush=True)
