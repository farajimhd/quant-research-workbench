...
class MaskConfig:
    ...
    # v13 keeps v8's fixed-mask schedule: every training batch masks the same
    # 70% of event tokens so only the BCE objective changes between v8 and v13.
...
class TrainConfig:
    ...
    wandb_project: str = "June2026-event-token-mae-v13-activations"
