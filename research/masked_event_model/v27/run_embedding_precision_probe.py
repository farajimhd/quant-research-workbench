...
DEFAULT_RUN_PREFIX = "v27-capacity-1shard5ep"
...
def main() -> int:
    ...
    print("v27 embedding-dimension / bottleneck-precision probe", flush=True)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Sequentially pretrain v27 embedding/precision variants on one x-only shard, "
