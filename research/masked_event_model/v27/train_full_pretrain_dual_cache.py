...
DEFAULTS.update(
    {
        ...
        "wandb_run_name": "v27-fullpretrain-dualcache-headermask050-emb32-bs8192-lr4e4-1epoch-freshrng",
    }
)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Run v27 full pretraining over all shards from cache_20260611_195259 "
...
def print_plan(
    ...
    print("v27 dual-cache full pretraining", flush=True)
