...
DEFAULT_CHECKPOINT = Path(
    ...
    r"\v27-fullpretrain-dualcache-headermask050-emb32-bs8192-lr4e4-1epoch-freshrng"
...
DEFAULT_PROBE_OUTPUT_ROOT = Path(r"D:\TradingML\runtimes\temporal_event_model\v1\cache_price_probe_v27")
DEFAULT_WANDB_PROJECT = "June2026-event-encoder-linear-probes"
DEFAULT_RUN_NAME = "v1-cache-probe-v27-headermask050-dualcache-1train1val-5ep-bs8192"


def main() -> int:
    parser = argparse.ArgumentParser(
        description=(
            "Run a temporal v1 linear probe on the latest v27 dual-cache "
            "pretraining checkpoint. The v27 encoder is frozen; only the probe "
            "head is trained."
        )
    )
    ...
    print("v27 latest-checkpoint temporal linear probe", flush=True)
