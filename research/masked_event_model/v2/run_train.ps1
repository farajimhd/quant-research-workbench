...
$runtimeCandidate = Join-Path $scriptDir 'research\masked_event_model\v2\train.py'
...
& "c:\Users\Mehdi\miniconda3\envs\ml4t\python.exe" -u (Join-Path $runtimeRoot 'research\masked_event_model\v2\train.py') `
