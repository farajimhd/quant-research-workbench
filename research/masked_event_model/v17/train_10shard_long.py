...
DEFAULTS: dict[str, Any] = {
    ...
    "wandb_mode": "online",
    "wandb_run_name": "v17-mlpdecoder-fixedmask070-emb32-bs4096-10shards",
...
PROFILED_TRAINING_PATH = (
    "v17 event-token MAE, per-masked-event MLP decoder, "
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Long v17 pretraining over 10 sample-cache shards. Defaults target the "
...
def print_plan(
    ...
    print("v17 long pretraining over sample-cache shards", flush=True)
