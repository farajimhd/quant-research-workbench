...
@dataclass(slots=True)
class TrainConfig:
    output_root: Path = Path("D:/TradingData/quant-research-workbench/market_data/models/masked_event_model/v1")
    batch_size: int = 256
    epochs: int = 3
    max_steps: int = 0
    ...
    wandb_run_name: str = "mem-v1-d512-e2-t8-d4-mask70-chunk500-nov2025"
