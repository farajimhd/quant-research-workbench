...
from research.masked_event_model.v28.train import build_scheduler, move_batch, resolve_amp_dtype
...
DEFAULT_RUN_DIR = Path(
    ...
    r"\v28-unweighted-fixedmask070-emb32-bs4096-unweightedmean-bf16-actuallrschedulerendofshard"
)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Replay v28 training from a checkpoint and inspect the backward pass. "
...
def main() -> None:
    ...
    print("v28 gradient replay debugger", flush=True)
