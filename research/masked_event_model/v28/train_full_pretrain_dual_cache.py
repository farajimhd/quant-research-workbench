...
DEFAULTS.update(
    {
        ...
        "wandb_run_name": "v28-fullpretrain-dualcache-headerrecon-emb32-bs8192-lr4e4-1epoch-freshrng",
    }
)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Run v28 full pretraining over all shards from cache_20260611_195259 "
...
def print_plan(
    ...
    print("v28 dual-cache full pretraining", flush=True)
