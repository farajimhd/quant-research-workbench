...
DEFAULT_RUN_PREFIX = "v28-groupedbottleneck128-1shard5ep"
...
def main() -> int:
    ...
    print(f"v28 grouped-bottleneck emb{args.embedding_dim} benchmark", flush=True)
...
def parse_args() -> tuple[argparse.Namespace, list[str]]:
    parser = argparse.ArgumentParser(
        description=(
            "Run the single v28 grouped-bottleneck comparison: emb128 BF16 by default "
