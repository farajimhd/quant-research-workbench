...
DEFAULT_RUN_PREFIX = "v28-capacity-1shard5ep"
...
def main() -> int:
    ...
    print("v28 embedding-dimension / bottleneck-precision probe", flush=True)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Sequentially pretrain v28 embedding/precision variants on one x-only shard, "
    ...
    parser.add_argument("--header-mask-ratio", type=float, default=0.50)
