...
DEFAULT_RUN_PREFIX = "v21-capacity-1shard5ep"
...
def main() -> int:
    ...
    print("v21 embedding-dimension / bottleneck-precision probe", flush=True)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Sequentially pretrain v21 embedding/precision variants on one x-only shard, "
