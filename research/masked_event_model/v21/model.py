...
from research.masked_event_model.v21.config import ModelConfig
from research.masked_event_model.v21.masking import EventMaskBatch, gather_events, maybe_corrupt_header, maybe_corrupt_visible_events
...
class FixedGridChunkBottleneck(nn.Module):
    ...
    v21 differs from v20 after this scatter step: instead of flattening all 130
...
class EventTokenMaskedAutoencoder(nn.Module):
    ...
    def __init__(self, *, events_per_chunk: int, config: ModelConfig) -> None:
        ...
        if self.input_representation != "bit":
            raise ValueError("v21 currently supports input_representation='bit' only")
