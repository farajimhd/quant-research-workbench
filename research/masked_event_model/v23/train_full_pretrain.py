...
DEFAULTS: dict[str, Any] = {
    ...
    "wandb_mode": "online",
    "wandb_run_name": "v23-fullpretrain-sharddecay-fixedmask070-emb80-bs8192-lr1e4-epoch09-shard095",
...
PROFILED_TRAINING_PATH = (
    "v23 full pretraining, residual per-masked-event MLP decoder, fixed-grid bottleneck, "
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Full v23 pretraining over the larger event sample cache. By default it "
...
def print_plan(values: dict[str, Any], train_shards, validation_shards, validation_batches: int, steps_per_epoch: int, argv: list[str]) -> None:
    ...
    print("v23 full pretraining over sample-cache shards", flush=True)
