...
DEFAULTS: dict[str, Any] = {
    ...
    "bottleneck_branch_embedding_dim": 8,
    "n_heads": 8,
    "encoder_layers": 10,
    "decoder_layers": 4,
    "ffn_mult": 4,
    ...
    "compile_model": True,
    "wandb_project": "June2026-event-token-mae-v23-residual-decoder",
    "wandb_entity": "mehdifaraji",
    "wandb_mode": "online",
    "wandb_run_name": "v23-mlpdecoder-fixedmask070-emb80-bs8192-10shards",
...
PROFILED_TRAINING_PATH = (
    "v23 event-token MAE, residual per-masked-event MLP decoder, "
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Long v23 pretraining over 10 sample-cache shards. Defaults target the "
            "medium emb80 bs8192 setup; model-size arguments are explicit so the "
...
def resolve_shard_plan(
    *,
    ...
    requested_validation = available_validation_shards[:validation_shard_count]
    validation_shards = []
...
def print_plan(
    ...
    print("v23 long pretraining over sample-cache shards", flush=True)
