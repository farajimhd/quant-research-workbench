...
DEFAULTS: dict[str, Any] = {
    ...
    "run_prefix": "v23-focused-fixedlr-profile",
    "steps": 200,
    "learning_rate": 2e-4,
    "scheduler": "none",
    "wandb_project": "June2026-event-token-mae-v23-variation-profile",
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description=(
            "Run five focused v23 profile variations sequentially. Each variation "
    ...
    command = [
        sys.executable,
        "-u",
        str(REPO_ROOT / "research" / "masked_event_model" / "v23" / "train_model_size_sweep.py"),
        "--profile-set",
        "focused",
        "--steps",
        str(known.steps),
    ...
    print("=" * 96, flush=True)
    print("v23 focused variation profile", flush=True)
