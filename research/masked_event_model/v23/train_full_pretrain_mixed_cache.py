...
SOURCE_CHECKPOINT = (
    ...
    r"\v23-fullpretrain-sharddecay-fixedmask070-emb80-bs8192-lr1e4-epoch09-shard095-continue5epochs"
...
DEFAULTS.update(
    {
        ...
        "wandb_run_name": "v23-fullpretrain-mixedcache-fixedmask070-emb80-bs8192-lr4e4-3epochs-freshrng-from-step260352",
    }
)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Start v23 full pretraining from the step-260352 checkpoint over a "
...
def print_plan(
    ...
    print("v23 mixed-cache full pretraining", flush=True)
