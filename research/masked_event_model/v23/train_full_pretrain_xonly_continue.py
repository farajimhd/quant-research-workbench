...
from research.masked_event_model.v23.train import main as train_main  # noqa: E402
from research.masked_event_model.v23.train_full_pretrain import (  # noqa: E402
...
MIXED_RUN_CHECKPOINT = (
    r"\\DESKTOP-SAAI85T\Workstation-D\TradingML\runtimes\masked_event_model\v23\pretrain"
    r"\v23-fullpretrain-mixedcache-fixedmask070-emb80-bs8192-lr4e4-3epochs-freshrng-from-step260352"
...
DEFAULTS.update(
    {
        ...
        "wandb_run_name": "v23-fullpretrain-xonly100-fixedmask070-emb80-bs8192-lr4e4-3epochs-freshrng-from-mixed-latest",
    }
)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Continue v23 full pretraining from the latest mixed-cache checkpoint, "
...
def print_plan(values: dict[str, Any], train_shards, validation_shards, validation_batches: int, steps_per_epoch: int, argv: list[str]) -> None:
    ...
    print("v23 x-only full pretraining continuation", flush=True)
