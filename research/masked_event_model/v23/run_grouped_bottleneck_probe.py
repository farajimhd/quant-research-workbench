...
DEFAULT_RUN_PREFIX = "v23-branch8resmlp80-1shard5ep"
...
def main() -> int:
    ...
    print("v23 branch8 residual-decoder emb80 benchmark", flush=True)
...
def parse_args() -> tuple[argparse.Namespace, list[str]]:
    parser = argparse.ArgumentParser(
        description=(
            "Run the single v23 branch8 residual-decoder comparison: emb80 BF16 "
