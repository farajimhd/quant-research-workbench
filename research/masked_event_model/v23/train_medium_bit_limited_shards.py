...
DEFAULTS: dict[str, Any] = {
    ...
    "wandb_mode": "online",
    "wandb_run_name": "v23-mlpdecoder-medium-event-token-emb80-bs8192-10shards",
    "warm_start_checkpoint": "",
}

PROFILED_TRAINING_PATH = "v23 event-token MAE medium emb80 bs8192 compile-enabled, shard-cycle scheduler, no interleave"
VALIDATION_BATCHES = 8


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train v23 event-token MAE on 10 sample-cache shards with one validation shard slice.")
...
def main() -> None:
    ...
    print("=" * 96, flush=True)
    print("v23 medium event-token limited-shard training", flush=True)
