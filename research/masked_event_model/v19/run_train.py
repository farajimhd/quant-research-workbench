...
def main() -> None:
    parser = argparse.ArgumentParser(description="Launch v19 event-token masked autoencoder training with editable defaults.")
...
def build_argv(values: dict[str, Any]) -> list[str]:
    argv = [sys.executable, "-m", "research.masked_event_model.v19.train"]
