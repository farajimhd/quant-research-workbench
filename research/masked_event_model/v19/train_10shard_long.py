...
DEFAULTS: dict[str, Any] = {
    ...
    "wandb_mode": "online",
    "wandb_run_name": "v19-mlpdecoder-fixedmask070-emb32-bs4096-10shards",
...
PROFILED_TRAINING_PATH = (
    "v19 event-token MAE, per-masked-event MLP decoder, "
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Long v19 pretraining over 10 sample-cache shards. Defaults target the "
...
def print_plan(
    ...
    print("v19 long pretraining over sample-cache shards", flush=True)
