...
PROFILED_TRAINING_PATH = "v16 event-token MAE medium f1 bs8192 compile-enabled, shard-cycle scheduler, no interleave"
VALIDATION_BATCHES = 8


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train v16 event-token MAE on 10 sample-cache shards with one validation shard slice.")
...
def main() -> None:
    ...
    print("=" * 96, flush=True)
    print("v16 medium event-token limited-shard training", flush=True)
