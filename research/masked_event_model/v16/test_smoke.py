...
from research.masked_event_model.v16.config import LossConfig, MaskConfig, ModelConfig
from research.masked_event_model.v16.losses import decode_masked_event_semantics, masked_event_bce_loss, masked_event_semantic_metrics, unpack_bits
...
def test_forward_and_encode_shapes() -> None:
    ...
    model = EventTokenMaskedAutoencoder(
        ...
        config=ModelConfig(
            ...
            decoder_bottleneck_tokens=2 + events // 2,
            n_heads=4,
            encoder_layers=1,
            decoder_layers=1,
        ),
