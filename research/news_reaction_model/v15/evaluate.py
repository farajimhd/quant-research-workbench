...
from research.news_reaction_model.v15.time_features import parse_published_at_utc
from research.news_reaction_model.v15.inference import opportunity_predictions
from research.news_reaction_model.v15.metrics import balanced_accuracy, macro_f1
...
from research.news_reaction_model.v15.prepare_data import q, qi
...
def parse_args(argv: Iterable[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Evaluate V15 three-class opportunities and the midpoint-return P&L proxy."
    )
