...
from research.news_reaction_model.v15.metrics import OpportunityAccumulator
from research.news_reaction_model.v15.model import NewsReactionModelV15
from research.news_reaction_model.v15.opportunity import OPPORTUNITY_CLASS_NAMES
...
def parse_args(argv: Iterable[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Evaluate one V15 checkpoint in eval mode over both its complete training "
