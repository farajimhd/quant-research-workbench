...
class LoaderConfig:
    ...
    # V15 builds a local indexed view over these exact V8 rows. OpenAI
    ...
    prepared_dataset_version: str = "news_reaction_openai_causal_context_dataset_v15"
...
class TrainConfig:
    ...
    # Keep the V3-V9 project so V15 remains directly comparable.
...
def default_run_name(config: ExperimentConfig) -> str:
    ...
    return (
        f"news-v15-opportunity-openai-prior-context-n{config.loader.context_size}"
