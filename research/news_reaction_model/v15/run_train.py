...
from research.news_reaction_model.v15.train import main
...
DEFAULT_ARGS = [
    ...
    "--run-name",
    "news-v15-opportunity-openai-prior4-7d-d384-a6-l4-b2048-e50-cosine-r49-gamma098",
]

if __name__ == "__main__":
    args = DEFAULT_ARGS + sys.argv[1:]
    print("COMMAND python -m research.news_reaction_model.v15.train " + " ".join(shlex.quote(value) for value in args), flush=True)
