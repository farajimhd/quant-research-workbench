...
from research.news_reaction_model.v11.train import main
...
DEFAULT_ARGS = [
    ...
    "--run-name",
    "news-v11-opportunity-openai-stock-state-causalv1-time-d384-l4-b2048-e50-cosine-r49-gamma098",
]

if __name__ == "__main__":
    args = DEFAULT_ARGS + sys.argv[1:]
    print("COMMAND python -m research.news_reaction_model.v11.train " + " ".join(shlex.quote(value) for value in args), flush=True)
