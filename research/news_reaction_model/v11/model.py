...
from research.news_reaction_model.v11.config import ModelConfig
from research.news_reaction_model.v11.opportunity import OPPORTUNITY_CLASSES
...
class NewsReactionModelV11(nn.Module):
    """Fixed V10 encoder with the packed-market V1 publication-time channel."""
...
def build_model_mermaid() -> str:
    return "\n".join(
        [
            ...
            '  time["Packed-market V1 time features, 12 values"] --> timeproj["Time projection"]',
