...
from research.news_reaction_model.v11 import HORIZONS, MODEL_VERSION
...
from research.news_reaction_model.v11.inference import opportunity_predictions
from research.news_reaction_model.v11.metrics import balanced_accuracy, macro_f1
...
class ClickHouseEvaluationDataset:
    ...
    def iter_batches(self) -> Iterator[EvaluationBatch]:
        ...
        threads = [
            threading.Thread(target=worker, name=f"news-v11-eval-{index}", daemon=True)
...
def parse_args(argv: Iterable[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Evaluate V11 three-class opportunities and the midpoint-return P&L proxy."
    )
