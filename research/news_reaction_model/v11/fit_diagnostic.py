...
from research.news_reaction_model.v11.metrics import OpportunityAccumulator
from research.news_reaction_model.v11.model import NewsReactionModelV11
from research.news_reaction_model.v11.opportunity import OPPORTUNITY_CLASS_NAMES
...
def parse_args(argv: Iterable[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Evaluate one V11 checkpoint in eval mode over both its complete training "
