...
from research.news_reaction_model.v2.train import main
...
DEFAULT_ARGS = [
    ...
    "--epochs", "10", "--scheduler-restarts", "2",
]

if __name__ == "__main__":
    args = DEFAULT_ARGS + sys.argv[1:]
    print("COMMAND python -m research.news_reaction_model.v2.train " + " ".join(shlex.quote(value) for value in args), flush=True)
