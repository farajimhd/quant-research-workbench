...
class LoaderConfig:
    ...
    dataset_table: str = "news_reaction_percentage_dataset_v4"
    dataset_version: str = "news_reaction_percentage_dataset_v4"
...
def default_run_name(config: ExperimentConfig) -> str:
    ...
    return f"news-v4-ranges-d{config.model.d_model}-l{config.model.layers}-b{config.loader.batch_size}"
