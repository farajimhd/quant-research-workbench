...
from research.news_reaction_model.v4.train import main
...
if __name__ == "__main__":
    ...
    print("COMMAND python -m research.news_reaction_model.v4.train " + " ".join(shlex.quote(value) for value in args), flush=True)
