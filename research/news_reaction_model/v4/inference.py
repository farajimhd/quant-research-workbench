...
from research.news_reaction_model.v4 import HORIZONS
from research.news_reaction_model.v4.config import LoaderConfig, ModelConfig
from research.news_reaction_model.v4.data import rows_to_batch
...
def load_model(checkpoint_path: str | Path, *, device: str | torch.device = "cpu") -> NewsReactionModelV4:
    ...
    model = NewsReactionModelV4(config).to(device)
