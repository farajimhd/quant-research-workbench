...
from research.news_reaction_model.v4 import HORIZONS, MODEL_VERSION
from research.news_reaction_model.v4.config import ExperimentConfig, LoaderConfig, ModelConfig, TrainConfig
from research.news_reaction_model.v4.data import make_dummy_batch, prepared_batch_sql, rows_to_batch, source_batch_sql
from research.news_reaction_model.v4.evaluate import PositionLedger, evaluation_batch_sql, rows_to_evaluation_batch, simulate_exits
from research.news_reaction_model.v4.inference import forecast_rows, trade_plans
from research.news_reaction_model.v4.losses import compute_loss
from research.news_reaction_model.v4.model import NewsReactionModelV4, NewsReactionRangeOutput
from research.news_reaction_model.v4.prepare_data import create_table_sql, insert_month_sql
from research.news_reaction_model.v4.profile_sizes import load_real_sample, main as profile_main
from research.news_reaction_model.v4.ranges import RANGE_SPECS, TARGET_NAMES, range_targets
from research.news_reaction_model.v4.train import SampleCosineRestartScheduler, checkpoint_payload, maybe_compile, restore, validate_config


class NewsReactionModelV4Tests(unittest.TestCase):
    ...
    def test_source_query_uses_raw_anchor_relative_returns_and_exact_identity(self) -> None:
        ...
        self.assertNotIn("abnormal_", sql)
        self.assertNotIn("robust_scale", sql)
    ...
    def test_prepared_contract_derives_classes_in_python(self) -> None:
        ...
        self.assertNotIn("class_targets", insert)
    ...
    def test_batch_model_range_loss_and_forecast(self) -> None:
        ...
        model = NewsReactionModelV4(ModelConfig(embedding_dim=8, d_model=16, hidden_dim=16, layers=1))
    ...
    def test_evaluation_query_loads_anchor_without_future_order_labels(self) -> None:
        ...
        rows = [{
            ...
            "chunks": [[0, [0.1] * 8]], "publication_session": "regular", "horizon_codes": ["1m"],
    ...
    def test_profiler_collects_exact_sample_and_rejects_truncation(self) -> None:
        ...
        with patch("research.news_reaction_model.v4.profile_sizes.ClickHouseNewsReactionDataset") as dataset_type:
        ...
        with tempfile.TemporaryDirectory() as temp_dir, patch("research.news_reaction_model.v4.profile_sizes.make_dummy_batch", return_value=first):
    ...
    def test_checkpoint_and_compile_fallback(self) -> None:
        ...
        with patch("research.news_reaction_model.v4.train.torch.cuda.is_available", return_value=True), patch("research.news_reaction_model.v4.train.importlib.util.find_spec", return_value=None), patch("research.news_reaction_model.v4.train.torch.compile") as compile_model:
