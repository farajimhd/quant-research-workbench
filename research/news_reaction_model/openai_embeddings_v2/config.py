...
DIMENSIONS = 3_072
EMBEDDING_VERSION = "benzinga_news_rendered_v2_openai_text_embedding_3_large_3072_v1"
TEXT_CONTRACT = "benzinga_article_sources_block_packed_v2_8000tokens"
...
def default_runtime_root() -> Path:
    return Path(
        os.environ.get(
            ...
            r"D:\market-data\prepared\news_reaction_model\openai_embeddings_v2",
        )
    )
...
class PipelineConfig:
    database: str = "q_live"
    source_table: str = "benzinga_news_rendered_v2"
    source_version: str = "benzinga_structured_renderer_v2+sec_packed_text_renderer_v9"
    news_database: str = "q_live"
    news_table: str = "benzinga_news_event_v2"
    source_ticker_table: str = "benzinga_news_ticker_v2"
    render_authority_table: str = "benzinga_news_render_authority_v2"
    embedding_table: str = "benzinga_news_openai_embedding_v2"
    ticker_link_table: str = "benzinga_news_openai_embedding_ticker_v2"
    item_table: str = "benzinga_news_openai_embedding_item_v2"
    batch_table: str = "benzinga_news_openai_embedding_batch_v2"
    model: str = MODEL
