...
from research.news_reaction_model.v12.metrics import OpportunityAccumulator
from research.news_reaction_model.v12.model import NewsReactionModelV12
from research.news_reaction_model.v12.opportunity import OPPORTUNITY_CLASS_NAMES
...
def parse_args(argv: Iterable[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Evaluate one V12 checkpoint in eval mode over both its complete training "
