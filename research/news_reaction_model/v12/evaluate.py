...
from research.news_reaction_model.v12 import HORIZONS, MODEL_VERSION
from research.news_reaction_model.v12.config import LoaderConfig, ModelConfig
...
from research.news_reaction_model.v12.inference import opportunity_predictions
from research.news_reaction_model.v12.metrics import balanced_accuracy, macro_f1
from research.news_reaction_model.v12.model import NewsReactionModelV12
...
class ClickHouseEvaluationDataset:
    ...
    def iter_batches(self) -> Iterator[EvaluationBatch]:
        ...
        threads = [
            threading.Thread(target=worker, name=f"news-v12-eval-{index}", daemon=True)
...
def parse_args(argv: Iterable[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Evaluate V12 three-class opportunities and the midpoint-return P&L proxy."
    )
...
def evaluate_checkpoint(
    ...
    *,
    ...
    model = NewsReactionModelV12(ModelConfig(**state["config"]["model"])).to(device)
