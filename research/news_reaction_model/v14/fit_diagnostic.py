...
from research.news_reaction_model.v14.metrics import OpportunityAccumulator
from research.news_reaction_model.v14.model import NewsReactionModelV14
from research.news_reaction_model.v14.opportunity import OPPORTUNITY_CLASS_NAMES
...
def parse_args(argv: Iterable[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Evaluate one V14 checkpoint in eval mode over both its complete training "
