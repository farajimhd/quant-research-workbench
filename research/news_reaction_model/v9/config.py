...
from research.news_reaction_model.v9.stock_state import STOCK_STATE_DIM
...
class LoaderConfig:
    ...
    # V9 changes only the supervised task and deliberately reuses exact V8 rows.
...
class TrainConfig:
    ...
    # Keep the V3-V8 project so V9 remains directly comparable.
...
def default_run_name(config: ExperimentConfig) -> str:
    ...
    return (
        f"news-v9-opportunity-openai-stock-state-d{config.model.d_model}"
