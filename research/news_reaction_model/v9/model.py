...
from research.news_reaction_model.v9.config import ModelConfig
from research.news_reaction_model.v9.opportunity import OPPORTUNITY_CLASSES
...
class NewsReactionModelV9(nn.Module):
    """V8 encoder with only one four-class opportunity head per horizon."""
...
def build_model_mermaid() -> str:
    return "\n".join(
        [
            ...
            "  pooling --> encoder",
            '  encoder --> opportunity["One four-class opportunity head per horizon"]',
