...
from research.news_reaction_model.v13.metrics import OpportunityAccumulator
from research.news_reaction_model.v13.model import NewsReactionModelV13
from research.news_reaction_model.v13.opportunity import OPPORTUNITY_CLASS_NAMES
...
def parse_args(argv: Iterable[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Evaluate one V13 checkpoint in eval mode over both its complete training "
