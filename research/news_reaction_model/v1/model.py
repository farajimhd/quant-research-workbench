...
from research.news_reaction_model.v1.config import ModelConfig
...
class NewsReactionModelV1(nn.Module):
    def __init__(self, config: ModelConfig) -> None:
        ...
        self.return_head = nn.Linear(d, 3)
    ...
    def forward(self, x: dict[str, Any]) -> NewsReactionOutput:
        ...
        return NewsReactionOutput(
            ...
            return_forecasts=self.return_head(fused),
...
def build_model_mermaid() -> str:
    return "\n".join([
        ...
        '  mlp --> returns["10 x target/high/low forecasts"]',
    ])
