...
from research.news_reaction_model.v6.config import ModelConfig
...
class NewsReactionModelV6(nn.Module):
    """V5 prediction stack plus a publication-time structured financial-number channel."""
    ...
    def forward(self, x: dict[str, Any]) -> NewsReactionRangeOutput:
        ...
        hidden = self.chunk_projection(torch.stack((word, char, numeric), dim=1))
