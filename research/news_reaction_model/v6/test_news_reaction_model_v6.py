...
from research.news_reaction_model.v6 import HORIZONS, MODEL_VERSION
...
from research.news_reaction_model.v6.config import ExperimentConfig, LoaderConfig, ModelConfig, NumericFeatureConfig, TrainConfig
from research.news_reaction_model.v6.data import make_dummy_batch, prepared_batch_sql, rows_to_batch
from research.news_reaction_model.v6.evaluate import PositionLedger, evaluation_batch_sql, rows_to_evaluation_batch, simulate_exits
from research.news_reaction_model.v6.inference import forecast_rows, trade_plans
...
from research.news_reaction_model.v6.prepare_data import create_table_sql, source_rows_sql
from research.news_reaction_model.v6.profile_sizes import load_real_sample, main as profile_main
from research.news_reaction_model.v6.ranges import RANGE_SPECS, TARGET_NAMES, range_targets
from research.news_reaction_model.v6.train import SampleCosineRestartScheduler, checkpoint_payload, maybe_compile, restore, validate_config
from research.news_reaction_model.v6.text_features import article_model_text


class NewsReactionModelV6Tests(unittest.TestCase):
    def test_version_split_scheduler_and_wandb_comparison_contract(self) -> None:
        loader, train = LoaderConfig(), TrainConfig()
        self.assertEqual(MODEL_VERSION, "v6")
    ...
    def test_source_query_reuses_v5_population_and_labels_without_recomputation(self) -> None:
        config = LoaderConfig()
    ...
    def test_batch_model_range_loss_and_forecast(self) -> None:
        ...
        model = NewsReactionModelV6(ModelConfig(word_vocab_size=16, char_vocab_size=16, numeric_vocab_size=16, d_model=16, hidden_dim=16, layers=1))
    ...
    def test_profiler_collects_exact_sample_and_rejects_truncation(self) -> None:
        ...
        with patch("research.news_reaction_model.v6.profile_sizes.ClickHouseNewsReactionDataset") as dataset_type:
        ...
        with tempfile.TemporaryDirectory() as temp_dir, patch("research.news_reaction_model.v6.profile_sizes.make_dummy_batch", return_value=first):
    ...
    def test_checkpoint_and_compile_fallback(self) -> None:
        ...
        with patch("research.news_reaction_model.v6.train.torch.cuda.is_available", return_value=True), patch("research.news_reaction_model.v6.train.importlib.util.find_spec", return_value=None), patch("research.news_reaction_model.v6.train.torch.compile") as compile_model:
