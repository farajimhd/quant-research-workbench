...
from research.news_reaction_model.v16.metrics import OpportunityAccumulator
from research.news_reaction_model.v16.model import NewsReactionModelV16
from research.news_reaction_model.v16.opportunity import OPPORTUNITY_CLASS_NAMES
...
def parse_args(argv: Iterable[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Evaluate one V16 checkpoint in eval mode over both its complete training "
