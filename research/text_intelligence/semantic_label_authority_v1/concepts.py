...
CONCEPT_RULES: tuple[ConceptRule, ...] = (
    ...
    ConceptRule("financing", "warrant", ("warrant exercise", "exercise price", "purchase warrants"), "mixed", -0.4),
    ...
    ConceptRule("guidance", "raise", ("raises guidance", "raised guidance", "increases guidance"), "positive", 1.2, time_orientation="forward"),
    ConceptRule("guidance", "cut", ("cuts guidance", "lowered guidance", "reduces guidance"), "negative", -1.4, time_orientation="forward"),
    ...
    ConceptRule("contract_order", "award", ("awarded a contract", "contract award", "purchase order"), "positive", 0.8),
