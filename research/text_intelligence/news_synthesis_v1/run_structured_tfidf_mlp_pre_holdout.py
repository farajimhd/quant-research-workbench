...
from .structured_tfidf_mlp_pre_holdout import train_and_evaluate, validate_artifacts
...
DEFAULT_OUTPUT = RUNTIME / "structured_tfidf_mlp_2025_through_2026_aug13_to_august_holdout_v1"


def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="Train sparse structured plus TF-IDF MLP and score sealed August tail"
    )
