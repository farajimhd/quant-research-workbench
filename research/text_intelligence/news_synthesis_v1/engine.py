...
ENGINE_VERSION = "news_synthesis_engine_v5"
...
class NewsSynthesisEngine:
    ...
    def _statements(
        ...
        *,
        ...
        if title and title.strip() != text.strip():
...
def _sentence_spans(text: str) -> list[tuple[int, int, str]]:
    ...
    abbreviations = {
        ...
        "jul", "aug", "sep", "sept", "oct", "nov", "dec", "u.s", "a.m", "p.m",
    }
