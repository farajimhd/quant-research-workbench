...
EVALUATION_VERSION = "news_synthesis_provider_context_evaluation_v1"
...
DEFAULT_OUTPUT_ROOT = Path(
    ...
    r"\provider_context_router_evaluation_v1"
)
...
def _markdown(report: Mapping[str, Any]) -> str:
    ...
    return "\n".join((
        ...
        *family_lines,
        ...
        "- Temporal novelty is calculated causally and stored in the decision trace, but is trace-only in v1 because it is not sufficiently precise alone.",
