...
from .structured_tfidf_rf_pre_holdout import train_and_evaluate, validate_artifacts
...
DEFAULT_BASE_MODEL = RUNTIME / "structured_metadata_rf_2025_through_2026_aug13_to_august_holdout_v1"
DEFAULT_TEXT_AUTHORITY = Path(
    r"D:\TradingML\runtimes\text_intelligence\llm_issuer_labeling_v4"
    r"\forecast_eligibility_rf_comparison_v1"
)
DEFAULT_OUTPUT = RUNTIME / "structured_tfidf_rf_2025_through_2026_aug13_to_august_holdout_v1"


def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="Train structured plus TF-IDF RF through August 13 and score sealed tail"
    )
    ...
    parser.add_argument("--base-model-root", type=Path, default=DEFAULT_BASE_MODEL)
