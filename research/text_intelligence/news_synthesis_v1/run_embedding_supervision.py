...
def _model_version_for_dataset(data_root: Path) -> str:
    ...
    if representation == "tfidf_v6_ablation":
        return TFIDF_V6_MODEL_VERSION
    if representation == "tfidf_v7":
    ...
    if representation == "tfidf_v10_relational_stable":
        return TFIDF_V10_MODEL_VERSION
