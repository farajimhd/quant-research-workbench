...
from .fresh_acceptance_v4 import build_acceptance_sample
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser = argparse.ArgumentParser(
        description="Prepare the fourth prediction-blind, session-balanced 200-News set."
    )
    parser.add_argument("--output-root", type=Path, default=base / "news_acceptance_200_v4")
