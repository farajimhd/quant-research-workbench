...
from .fresh_acceptance_v2 import build_acceptance_sample
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser = argparse.ArgumentParser(
        description="Prepare the second prediction-blind, session-balanced 100-News set."
    )
    parser.add_argument("--output-root", type=Path, default=base / "news_acceptance_100_v2")
    parser.add_argument("--human-root", type=Path, default=base / "news_1100_v1")
