...
from research.inhouse_transformer.v6.metrics import append_jsonl  # noqa: E402
from research.inhouse_transformer.v6.model_lstm import SimpleLSTMForecaster  # noqa: E402
    ...
    def __iter__(self) -> Iterator[dict[str, torch.Tensor]]:
        ...
        for epoch in range(self.epochs):
            ...
            batch = ActualBatchBuilder(
                ...
                input_size=len(ACTUAL_FEATURE_COLUMNS),
...
def main() -> None:
    ...
    print(
        f"LSTM model: input_size={len(ACTUAL_FEATURE_COLUMNS)} "
