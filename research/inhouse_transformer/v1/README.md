# In-House 1m Bar Transformer Baseline v1

This module trains a scratch PyTorch transformer baseline on provider-built 1-minute bars.

This folder preserves the pre-v2 experiment snapshot, including the
actual-price z-score target setup and chronological overfit prediction charts.
