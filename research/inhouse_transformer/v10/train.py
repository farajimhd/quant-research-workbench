...
from research.inhouse_transformer.v10.config import (  # noqa: E402
    DataConfig,
    ExperimentConfig,
    ModelConfig,
    TrainConfig,
...
from research.inhouse_transformer.v10.metrics import MetricAccumulator, append_jsonl  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help=(
            "Main transformer target format. v10 defaults to return_bps so the model predicts the next move "
...
def load_torch_stack() -> None:
    ...
    try:
        ...
        from research.inhouse_transformer.v10.model import (
