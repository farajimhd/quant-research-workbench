...
class DataConfig:
    ...
    macro_context_length: int = 32
    macro_15m_bucket_minutes: int = 15
    macro_1h_bucket_minutes: int = 60
    macro_1d_bucket_minutes: int = 1440
    anchor_history_sessions: int = 10
    anchor_window_minutes: int = 5
    horizon: int = 3
...
class ModelConfig:
    ...
    macro_gate_init_bias: float = -3.0
    macro_dropout: float = 0.1
