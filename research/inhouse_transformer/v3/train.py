...
from research.inhouse_transformer.v3.config import (  # noqa: E402
    DataConfig,
    ExperimentConfig,
    ModelConfig,
    TrainConfig,
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help=(
            "Main transformer target format. v3 defaults to return_bps so the model predicts the next move "
...
def load_torch_stack() -> None:
    ...
    try:
        ...
        from research.inhouse_transformer.v3.model import (
