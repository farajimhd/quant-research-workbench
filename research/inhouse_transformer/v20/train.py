...
from research.inhouse_transformer.v20.config import (  # noqa: E402
    DataConfig,
    ExperimentConfig,
    ModelConfig,
    TrainConfig,
)
from research.inhouse_transformer.v20.data import (  # noqa: E402
    BatchBuilder,
...
from research.inhouse_transformer.v20.metrics import MetricAccumulator, append_jsonl  # noqa: E402
...
METRIC_DESCRIPTIONS: dict[str, dict[str, str]] = {
    ...
    "loss": {
        ...
        "unit": "target units",
        "interpretation": "Down is better. For v20 this is binary cross entropy over sign plus magnitude bits.",
    },
    "regression_loss": {
    ...
    "h1_hard_decoded_mae_bps": {
        ...
        "unit": "bps",
        "interpretation": "Down is better. This is the legacy v20 decoded prediction error.",
    },
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help=(
            "Main transformer target format. v20 uses sign plus 12 magnitude bits for log-return bps."
        ),
    )
    parser.add_argument(
        "--target-columns",
    ...
    parser.add_argument(
        "--max-synthetic-minutes",
        type=int,
        default=defaults.data.max_synthetic_minutes,
        help="Maximum forward-filled no-trade minutes to keep after a ticker's latest real bar.",
    )
...
def config_from_args(args: argparse.Namespace) -> ExperimentConfig:
    ...
    data = DataConfig(
        ...
        max_synthetic_minutes=args.max_synthetic_minutes,
    )
    model = ModelConfig(
...
def config_to_dict(config: ExperimentConfig) -> dict[str, Any]:
    return {
        ...
        "data": {
            ...
            "max_synthetic_minutes": config.data.max_synthetic_minutes,
        },
        "model": {
...
def load_torch_stack() -> None:
    ...
    try:
        ...
        from research.inhouse_transformer.v20.model import (
