# Colab Package for v14

Files in this folder are generated for Colab training.

## Drive Paths

- Code package in Colab: `/content/drive/MyDrive/quant-research-workbench/colab_code/v14`
...
- output name: `v14_generalization_june2025_all_tickers`
- wandb run name: `v14-generalization-june2025-all-tickers`
- resume latest: `True`
