...
from research.inhouse_transformer.v11.config import DataConfig, TrainConfig  # noqa: E402
from research.inhouse_transformer.v11.data import (  # noqa: E402
    available_sessions,
    column_array,
    combine_carryover,
    iter_ticker_frames,
...
from research.inhouse_transformer.v11.metrics import append_jsonl  # noqa: E402
from research.inhouse_transformer.v11.model_lstm import SimpleLSTMForecaster  # noqa: E402
    ...
    def __iter__(self) -> Iterator[dict[str, torch.Tensor]]:
        ...
        for epoch in range(self.epochs):
            ...
            batch = ActualBatchBuilder(
                ...
                input_size=len(ACTUAL_FEATURE_COLUMNS) + len(self.config.time_feature_columns),
...
def main() -> None:
    ...
    print(
        f"LSTM model: input_size={len(ACTUAL_FEATURE_COLUMNS) + len(data_config.time_feature_columns)} "
    ...
    model = SimpleLSTMForecaster(
        input_size=len(ACTUAL_FEATURE_COLUMNS) + len(data_config.time_feature_columns),
