...
$python = if (Test-Path -LiteralPath (Join-Path $env:USERPROFILE "miniconda3\envs\ml4t\python.exe")) {
    Join-Path $env:USERPROFILE "miniconda3\envs\ml4t\python.exe"
}
elseif (Test-Path -LiteralPath (Join-Path $env:USERPROFILE "anaconda3\envs\ml4t\python.exe")) {
