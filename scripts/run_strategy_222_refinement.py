...
def prepare(name, overrides=None):
    ...
    if name == 'corrected-baseline':
        return baseline
    recipe_name='failure-memory-v16' if name in ('progress-v17','add-wick-v18','burst-rate-v19','range-v20','unprotected-v21','reclaim-attempt-v22','surge-base-v23','surge-range-v24','regular-base-v25','current-gain-v26','phase-progress-v27') else name
    ...
    if name in ('add-wick-v18','burst-rate-v19','range-v20','unprotected-v21','reclaim-attempt-v22','surge-base-v23','surge-range-v24','regular-base-v25','current-gain-v26','phase-progress-v27'):
        profile['parameters']['historical_hod']['setup_add_maximum_upper_wick_fraction']=.25
    if name in ('range-v20','unprotected-v21','reclaim-attempt-v22','surge-base-v23','surge-range-v24','regular-base-v25','current-gain-v26','phase-progress-v27'):
        profile['parameters']['historical_hod']['setup_minimum_300s_range_pct']=5.
    if name in ('unprotected-v21','reclaim-attempt-v22','surge-base-v23','surge-range-v24','regular-base-v25','current-gain-v26','phase-progress-v27'):
        profile['parameters']['historical_hod']['setup_recovery_unprotected_reentry']=1
    if name in ('reclaim-attempt-v22','surge-base-v23','surge-range-v24','regular-base-v25','current-gain-v26','phase-progress-v27'):
        profile['parameters']['historical_hod']['setup_recovery_entry_reclaim']=1
    if name in ('surge-base-v23','surge-range-v24','regular-base-v25','current-gain-v26','phase-progress-v27'):
    ...
    if name in ('surge-range-v24','regular-base-v25','current-gain-v26','phase-progress-v27'):
        profile['parameters']['historical_hod']['setup_minimum_300s_range_pct']=4.
    if name in ('regular-base-v25','current-gain-v26','phase-progress-v27'):
        profile['parameters']['historical_hod']['setup_recovery_regular_base']=1
    if name in ('current-gain-v26','phase-progress-v27'):
        profile['parameters']['historical_hod']['setup_trail_requires_current_gain']=1
    if name=='phase-progress-v27':
