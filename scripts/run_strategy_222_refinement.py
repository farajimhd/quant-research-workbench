...
def prepare(name, overrides=None, recipe_base=None):
    ...
    if recipe_name in ('support-body-v12','trail-v13','trail-no-failure-v14','strict-recovery-v15','failure-memory-v16'):
        profile['parameters']['historical_hod']['setup_minimum_body_bps']=5.
    if recipe_name in ('trail-v13','trail-no-failure-v14','strict-recovery-v15','failure-memory-v16'):
        profile['parameters']['historical_hod']['setup_minimum_trail_progress_r']=.5
    if recipe_name in ('trail-no-failure-v14','strict-recovery-v15'):
        # Historical experiment: disables both forced exits and failed-entry
        # observation. Retained for reproducibility; v16 separates them.
        profile['parameters']['historical_hod']['setup_failure_seconds']=0
    if recipe_name in ('strict-recovery-v15','failure-memory-v16'):
        profile['parameters']['historical_hod']['setup_base_recovery_maximum_range_pct']=0
    if recipe_name=='failure-memory-v16':
        profile['parameters']['historical_hod'].update(
    ...
    if name in ('add-wick-v18','burst-rate-v19','range-v20','unprotected-v21','reclaim-attempt-v22','surge-base-v23','surge-range-v24','regular-base-v25','current-gain-v26','phase-progress-v27','phase-add-v28','price-trail-v29','price-trail-only-v30','regular-origin-v31'):
        profile['parameters']['historical_hod']['setup_add_maximum_upper_wick_fraction']=.25
    if name in ('range-v20','unprotected-v21','reclaim-attempt-v22','surge-base-v23','surge-range-v24','regular-base-v25','current-gain-v26','phase-progress-v27','phase-add-v28','price-trail-v29','price-trail-only-v30','regular-origin-v31'):
        profile['parameters']['historical_hod']['setup_minimum_300s_range_pct']=5.
    if name in ('unprotected-v21','reclaim-attempt-v22','surge-base-v23','surge-range-v24','regular-base-v25','current-gain-v26','phase-progress-v27','phase-add-v28','price-trail-v29','price-trail-only-v30','regular-origin-v31'):
        profile['parameters']['historical_hod']['setup_recovery_unprotected_reentry']=1
    if name in ('reclaim-attempt-v22','surge-base-v23','surge-range-v24','regular-base-v25','current-gain-v26','phase-progress-v27','phase-add-v28','price-trail-v29','price-trail-only-v30','regular-origin-v31'):
        profile['parameters']['historical_hod']['setup_recovery_entry_reclaim']=1
    if name in ('surge-base-v23','surge-range-v24','regular-base-v25','current-gain-v26','phase-progress-v27','phase-add-v28','price-trail-v29','price-trail-only-v30','regular-origin-v31'):
    ...
    if name in ('surge-range-v24','regular-base-v25','current-gain-v26','phase-progress-v27','phase-add-v28','price-trail-v29','price-trail-only-v30','regular-origin-v31'):
        profile['parameters']['historical_hod']['setup_minimum_300s_range_pct']=4.
    if name in ('regular-base-v25','current-gain-v26','phase-progress-v27','phase-add-v28','price-trail-v29','price-trail-only-v30','regular-origin-v31'):
        profile['parameters']['historical_hod']['setup_recovery_regular_base']=1
    if name in ('current-gain-v26','phase-progress-v27','phase-add-v28','price-trail-v29','price-trail-only-v30','regular-origin-v31'):
        profile['parameters']['historical_hod']['setup_trail_requires_current_gain']=1
    if name in ('phase-progress-v27','phase-add-v28','price-trail-v29','price-trail-only-v30','regular-origin-v31'):
        profile['parameters']['historical_hod']['setup_phase_minimum_progress_r']=.5
    if name in ('phase-add-v28','price-trail-v29','price-trail-only-v30','regular-origin-v31'):
        profile['parameters']['historical_hod']['setup_add_requires_range_breakout']=1
    if name in ('price-trail-v29','price-trail-only-v30','regular-origin-v31'):
        profile['parameters']['historical_hod']['setup_trail_current_gain_requires_bid']=0
    if name in ('price-trail-only-v30','regular-origin-v31'):
    ...
    if name=='regular-origin-v31':
        profile['parameters']['historical_hod']['setup_recovery_regular_full_range']=1
...
def load_recipe(path):
    ...
    allowed={'portfolio_mandate':{'maximum_positions'},
        ...
        'setup_quote_confirmation_enabled','setup_quote_range_minimum_fraction','setup_minimum_volume_ratio',
        'setup_minimum_session_relative_volume','cash_fraction'}}
