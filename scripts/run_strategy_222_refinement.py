...
def prepare(name, overrides=None):
    ...
    if name == 'corrected-baseline':
        return baseline
    recipe_name='failure-memory-v16' if name in ('progress-v17','add-wick-v18','burst-rate-v19','range-v20','unprotected-v21') else name
