...
from src.market_engine.hindsight_phase3 import (VERSION,Lot,Node,SearchConfig,
...
def run(args,console):
    ...
    plan = dict(version=VERSION,phase2_root=str(source),phase2_plan_hash=source_plan['plan_hash'],
        ...
        code_hashes={p:file_hash(REPO/p) for p in (
            'scripts/build_hindsight_phase3.py','src/market_engine/hindsight_phase3.py',
            'src/market_engine/hindsight_market_values.py')})
