...
```powershell
python \\DESKTOP-SAAI85T\Workstation-D\TradingML\codes\masked_event_model\v4\research\mlops\sec_bulk_clickhouse_ingest.py --dry-run --artifact-root-win D:/market-data/sec_core --output-root-win D:/market-data/prepared/sec_core
```

Small schema/parser smoke test:

```powershell
python \\DESKTOP-SAAI85T\Workstation-D\TradingML\codes\masked_event_model\v4\research\mlops\sec_bulk_clickhouse_ingest.py --artifact-root-win D:/market-data/sec_core --output-root-win D:/market-data/prepared/sec_core --sources company_tickers,company_tickers_exchange,company_tickers_mf,submissions,companyfacts --limit-ciks 10 --batch-size 5000
```
