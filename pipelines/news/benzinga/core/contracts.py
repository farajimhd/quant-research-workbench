...
class NewsPipelineResult:
    ...
    body_event_row: dict[str, Any] = field(default_factory=dict)
    body_source_rows: list[dict[str, Any]] = field(default_factory=list)
    body_block_rows: list[dict[str, Any]] = field(default_factory=list)
    body_rendered_row: dict[str, Any] = field(default_factory=dict)
    body_ticker_links: list[dict[str, Any]] = field(default_factory=list)
    body_lineage_row: dict[str, Any] = field(default_factory=dict)
