...
class NewsPipelineResult:
    ...
    body_v3_event_row: dict[str, Any] = field(default_factory=dict)
    body_v3_source_rows: list[dict[str, Any]] = field(default_factory=list)
    body_v3_block_rows: list[dict[str, Any]] = field(default_factory=list)
    body_v3_rendered_row: dict[str, Any] = field(default_factory=dict)
    body_v3_ticker_links: list[dict[str, Any]] = field(default_factory=list)
    body_v3_lineage_row: dict[str, Any] = field(default_factory=dict)
