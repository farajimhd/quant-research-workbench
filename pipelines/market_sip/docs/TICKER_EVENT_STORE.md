...
ClickHouse unified event table design uses `event_meta UInt8` plus five explicit
`condition_token_* UInt8` columns. Trade corrections are filtered before event construction,
not packed as model input. See
