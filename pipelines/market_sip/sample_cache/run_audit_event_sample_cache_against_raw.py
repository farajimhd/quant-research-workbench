...
def main() -> None:
    parser = argparse.ArgumentParser(description="Launch sample-cache raw-source audit with editable defaults.")
...
def build_argv(values: dict[str, Any]) -> list[str]:
    argv = [sys.executable, "-m", "pipelines.market_sip.sample_cache.audit_event_sample_cache_against_raw"]
